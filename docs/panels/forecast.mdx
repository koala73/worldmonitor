...
- **Cmd+K**: type *forecast*, *ai forecast*, or *predictions ai*.
- Enabled by default on most variants. The command palette label is "AI Forecasts" even though the internal panel id is `forecast`.
