...
| Score | Level | Meaning |
|-------|-------|---------|
| 70-100 | **High** | Multiple converging crises |
| 40-69 | **Medium** | Heightened global tension |
| 0-39 | **Low** | Lower global strategic pressure |
...
|------------|-----------|---------|
| UCDP active war | >= 70 | UCDP war-level classification |
| UCDP minor conflict | >= 50 | UCDP minor-conflict classification |
