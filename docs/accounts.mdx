...
<Info>
**The free dashboard requires no account.** Everything listed under the Free plan — 55 free map layers, 500+ feeds, country briefs, watchlists — works anonymously at [worldmonitor.app](https://worldmonitor.app). Create an account only when you want Pro/API features or need to mint an API key.
</Info>
