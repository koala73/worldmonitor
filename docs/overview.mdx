...
World Monitor publishes a public, searchable [Data Source Catalog](https://worldmonitor.app/sources). Its manifest-derived inventory currently lists 529 active providers, 531 upstream hosts, 291 structured endpoints, and 268 news and OSINT feeds. The separate application inventory records 632 configured feed definitions, and the Telegram catalog enables 56 channels. These figures describe different inventory layers and should not be added together.
