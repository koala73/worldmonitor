...
| `POST /api/brief/share-url` | 30 | 60 s | Per user |
| `POST /api/notification-channels` | 30 | 60 s | Per user |
| `POST /api/create-checkout` | 20 | 60 s | Per user |
| `POST /api/register-interest` | 5 | 60 s | Per IP |
| `POST /api/contact` | 3 | 60 s | Per IP + Turnstile |
