...
**Self-hosting instead of subscribing**: permitted, with no plan required. [Self-hosting: what you get, what you run, what needs a licence](/self-hosting) sets out what the source gives you, what stays on our hosted infrastructure, and when a commercial licence applies.
