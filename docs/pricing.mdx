...
| **Pro Business** | $49.99/month · $449/year | Everything in Pro for client work, internal tools and reporting — data export, 25 dashboards, 250 MCP calls/day, priority support |
| **API Starter** | $99.99/month · $899/year | REST API + SDKs, license / API key included, 1,000 requests/day starter limit, webhooks — commercial license for your organization |
