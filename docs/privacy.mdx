...
This Privacy Policy explains how World Monitor, based in the United Arab Emirates ("World Monitor", "we", "us"), handles information when you use the World Monitor dashboard, website, API, MCP server, and apps (the "Service").
...
- **Page-performance monitoring (RUM)** via DebugBear on a 10% sample of page loads. It receives the page path, viewport and device pixel ratio, navigation and web-vitals timings, and the user agent, along with the IP address inherent in any web request. It is used to find slow and unstable pages, not to identify or track you.
