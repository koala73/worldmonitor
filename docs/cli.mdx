...
description: "Script country briefs, risk scores, and any of the 59 MCP tools from your shell with the official worldmonitor npm CLI — no API integration to write."
---
...
|---|---|---|
| `world` | `get_world_brief` | Precomputed, citation-grounded global situation brief |
