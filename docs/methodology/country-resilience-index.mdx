...
The WorldMonitor Country Resilience Index (CRI) scores the 196-country public rankable universe on a 0-100 scale. It combines long-run structural capacity with current operational stress. Upstream feeds can include more territories, but the public CRI ranking uses the rankable universe before publication.
