...
is derived from the audited import-dependency observation already carried by
the resilience static source: Eurostat `nrg_ind_id` for covered European
countries and World Bank `EG.IMP.CONS.ZS` elsewhere:
