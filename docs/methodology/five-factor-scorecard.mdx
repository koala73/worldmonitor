...
country counts: food 80, energy 120, demographics 150, technology 120,
defense 30. These floors came from an audit of 196 countries against production
sources, with headroom for normal coverage wobble. A partial source outage
...
from World Bank net energy imports (`EG.IMP.CONS.ZS`):
