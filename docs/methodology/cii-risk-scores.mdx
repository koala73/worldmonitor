...
> 2-year window, but the Redis writers currently retain a 365-day trailing event
> slice, so live scoring is seed-input-bounded until UCDP retention is widened.
