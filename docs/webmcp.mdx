...
| `open_dashboard_panel` | Required string `panelId`, 1–96 characters, pattern `^[a-z0-9][a-z0-9@_-]*$`; no additional properties. | Opens and scrolls to an available panel through the entitlement-aware UI path. |
