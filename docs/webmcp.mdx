...
| `src/App.ts` and `src/app/webmcp-dashboard.ts` | Startup ordering, UI-readiness gate, teardown, dashboard context, map-layer catalog snapshot, and human-path action binding. |
