...
| `src/App.ts`, `src/app/webmcp-dashboard.ts`, and `src/app/event-handlers.ts` | Startup ordering, UI-readiness gate, teardown, dashboard context, monitor/settings/alerts navigation, and human-path action binding. |
