...
| `list_five_factor_scorecards` | Compact country-by-country five-factor pillar scores, bands, coverage, and insufficient-data reasons. Use the single-scorecard tool for the full evidence ledger. |
