...
The single bundled spec is at [`/openapi.yaml`](https://www.worldmonitor.app/openapi.yaml) — feed it to any OpenAPI generator to produce typed clients for all 36 generated services in one pass, including platform services that do not have dedicated sidebar pages.
