...
Beyond static discovery documents, several live endpoints exist specifically for agents. All of them are anonymous and quota-free; each has its own per-IP rate limit.
