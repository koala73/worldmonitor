...
- Weather alerts for the United States and Canada (NWS, ECCC)
...
| National Weather Service | US active weather alerts | [api.weather.gov](https://api.weather.gov/alerts/active) |
| Environment and Climate Change Canada | Canada active weather alerts | [api.weather.gc.ca](https://api.weather.gc.ca/) |
