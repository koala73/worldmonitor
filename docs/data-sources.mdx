...
| [Environment & Disasters](#environment-%26-disasters) | Earthquakes, disasters, wildfires, cyclones, climate anomalies | USGS, CWFIS/NRCan, BC Wildfire Service, GDACS, NASA FIRMS/EONET, Open-Meteo |
...
- NASA FIRMS satellite fire detection (VIIRS thermal hotspots) merged with CWFIS national agency-reported active fires and BC Wildfire current fire points (OpenMaps KML); prescribed burns are labelled and never paged as emergencies
...
| CWFIS / CWFIF (NRCan) | Canadian national active and prescribed wildland fires (WFS) | [geoserver.cwfif.nrcan.gc.ca](https://geoserver.cwfif.nrcan.gc.ca/geoserver/ows?service=WFS&version=2.0.0&request=GetCapabilities) |
| BC Wildfire Service | B.C. current wildfire points (OpenMaps KML / PROT_CURRENT_FIRE_PNTS_SP); enriches CWFIS | [openmaps.gov.bc.ca](https://openmaps.gov.bc.ca/kml/geo/layers/WHSE_LAND_AND_NATURAL_RESOURCE.PROT_CURRENT_FIRE_PNTS_SP_loader.kml) |
