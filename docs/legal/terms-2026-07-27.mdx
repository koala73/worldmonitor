---
title: "World Monitor terms of service — archived version, 27 July 2026"
description: "Archived snapshot of the World Monitor Terms of Service effective 27 July 2026. Kept verbatim so a recorded acceptance of version 2026-07-27 resolves to the exact text that was accepted."
---

<Note>
  This is an **archived** version of the Terms, kept so an acceptance recorded against version
  `2026-07-27` resolves to the exact text that was accepted. It is not the current agreement —
  read the [current Terms of Service](/terms).
</Note>
