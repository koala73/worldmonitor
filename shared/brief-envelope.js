 ...
 *
 * v3 (2026-04-25): BriefDigest.publicLead added. Holds a
 * non-personalised lead generated by generateDigestProsePublic for
 * the share-URL surface, so api/brief/public/* never serves the
 * personalised `lead` (which carries profile context — watched
 * assets/regions). The renderer's public-mode lead block reads
 * publicLead when present and OMITS the pull-quote when absent —
 * never falls back to the personalised lead. v2 envelopes already
 * in TTL stay readable through SUPPORTED_ENVELOPE_VERSIONS.
 *
 * @type {3}
 */
