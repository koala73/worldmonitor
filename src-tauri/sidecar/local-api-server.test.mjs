...
test('pickPinnedAddress returns records for both IPv4 and IPv6 addresses to prevent TOCTOU DNS rebinding (#5921)', () => {
...
test('makePinnedLookup supports multi-family pinned records and prevents unpinned fallback (#5921)', async () => {
