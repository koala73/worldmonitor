...
export const UPSTREAM_TIMEOUT_MS = 600_000; // 10 minutes for local LLMs
export const GROQ_API_URL = process.env.LLM_API_URL || 'https://api.groq.com/openai/v1/chat/completions';
export const GROQ_MODEL = process.env.LLM_MODEL || 'llama-3.1-8b-instant';
