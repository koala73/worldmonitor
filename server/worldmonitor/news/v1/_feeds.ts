...
export const VARIANT_FEEDS: Record<string, Record<string, ServerFeed[]>> = {
  full: {
    ...
    conflict: [
      { name: 'ISW', url: 'https://www.understandingwar.org/feed' },
      { name: 'Airwars', url: 'https://airwars.org/feed/' },
    ...
    arms: [
      ...
      { name: 'Arms Control Assn', url: 'https://www.armscontrol.org/rss.xml' },
...
export const INTEL_SOURCES: ServerFeed[] = [
  ...
  { name: 'Stars and Stripes', url: 'https://www.stripes.com/rss' },
