...
const DISCLOSURE_ISSUE_URL = 'https://github.com/koala73/worldmonitor/issues/5504';
...
export const PUBLISHED_ESTIMATE_CLAIMS: readonly PublishedEstimateClaim[] = [
  {
  ...
  },
  {
    ...
    status: 'verified',
    coveredMetricPaths: ['summary.provenance'],
    includedInHighlightedAggregate: false,
    reportedValue: 180_000_000_000,
    reportedUnit: 'USD',
  ...
  },
  {
    ...
    status: 'unverified',
    coveredMetricPaths: ['summary.crypto.daily_inflow_usd'],
    includedInHighlightedAggregate: false,
    reportedValue: 2_000_000_000,
    reportedUnit: 'USD',
...
export function buildPublishedEstimateSummary(
  ...
  return {
    ...
    institutional: {
      oecdOdaAnnualUsdBn: verifiedContextValue(claims, 'oecd_oda_usd_bn'),
      oecdDataYear: verifiedContextValue(claims, 'oecd_oda_usd_bn') > 0 ? 2023 : 0,
