...
const GENERATED = new Map<string, { iata: string; name: string }>([
  ["--+", { iata: "-+", name: "U.S. Air" }],
  ["...", { iata: "..", name: "Avilu" }],
  ["0MM", { iata: "0M", name: "All America MX" }],
  ["1CH", { iata: "1C", name: "OneChina" }],
  ["1QA", { iata: "M4", name: "Marysya Airlines" }],
  ["2K2", { iata: "2X", name: "Regionalia Uruguay" }],
  ["3FF", { iata: "3F", name: "Fly Colombia ( Interliging Flights )" }],
  ["4AA", { iata: "FA", name: "Epic Holiday" }],
  ["666", { iata: "B0", name: "Aws express" }],
  ["6CC", { iata: "6C", name: "Vuela Cuba" }],
  ["7KK", { iata: "7O", name: "All Colombia" }],
  ["7ZC", { iata: "0Y", name: "All America CO" }],
  ["8K8", { iata: "88", name: "All Australia" }],
  ["99F", { iata: "9A", name: "All Africa" }],
  ["9XX", { iata: "9X", name: "Regionalia Venezuela" }],
  ["A1F", { iata: "A1", name: "Atifly" }],
  ["A9B", { iata: "1Y", name: "All America BR" }],
  ...
  ["AL1", { iata: "L1", name: "All Argentina" }],
  ["AL2", { iata: "A2", name: "All America" }],
  ["AL3", { iata: "L9", name: "All Asia" }],
  ...
  ["BA1", { iata: "B1", name: "Baltic Air lines" }],
  ...
  ["CR1", { iata: "9J", name: "Regionalia Chile" }],
  ["CR7", { iata: "C7", name: "Sky Wing Pacific" }],
  ...
  ["CX0", { iata: "0X", name: "Copenhagen Express" }],
  ...
  ["DC2", { iata: "KZ", name: "Dense Connection" }],
  ...
  ["GA0", { iata: "0G", name: "Global Airlines" }],
  ...
  ["HA1", { iata: "H1", name: "Hankook Air US" }],
  ...
  ["IG1", { iata: "G1", name: "Indya Airline Group" }],
  ...
  ["J88", { iata: "N4", name: "Regionalia México" }],
  ...
  ["M1F", { iata: "M1", name: "Maryland Air" }],
  ["M7A", { iata: "2R", name: "All America AR" }],
  ...
  ["N12", { iata: "12", name: "12 North" }],
  ["N77", { iata: "N7", name: "All Spain" }],
  ["N78", { iata: "9N", name: "Regional Air Iceland" }],
  ["N99", { iata: "N9", name: "All Europe" }],
  ...
  ["R1R", { iata: "1R", name: "All America CL" }],
  ...
  ["SA1", { iata: "S1", name: "Serbian Airlines" }],
  ...
  ["T&O", { iata: "&T", name: "Tom\\\\'s & co airliners" }],
  ["T9P", { iata: "ZT", name: "Tomp Airlines" }],
  ...
  ["TP6", { iata: "T6", name: "Trans Pas Air" }],
  ...
  ["VC9", { iata: "9V", name: "Volotea Costa Rica" }],
  ...
  ["WE1", { iata: "W1", name: "World Experience Airline" }],
  ...
  ["Z9H", { iata: "Z0", name: "All Argentina Express" }],
