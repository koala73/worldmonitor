...
description: "Build intelligence apps on World Monitor's typed API: 35 services, 283 proto files, 80+ edge functions, and auto-generated TypeScript clients. AGPL-3.0."
...
- **283 proto files** defining every data structure and service
...
| Contracts | Protocol Buffers (283 files) |
| Desktop | Tauri (Rust) |
| Sidecar | Node.js |
| Caching | Redis |
...
**Start building at [github.com/koala73/worldmonitor](https://github.com/koala73/worldmonitor). 35 services, 283 proto files, and a global intelligence dataset waiting for your application.**
