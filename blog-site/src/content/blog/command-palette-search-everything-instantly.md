...
Type any country name and instantly pull up its full intelligence dossier: CII score, active signals, AI analysis, infrastructure exposure, and 7-day timeline. Country names are searchable in all 27 supported languages, so typing "Allemagne" finds Germany, "Japón" finds Japan.
...
With [27 languages supported](/blog/posts/worldmonitor-in-21-languages-global-intelligence-for-everyone/), the command palette adapts to your locale. Country names and common commands are searchable in:
...
Absolutely. The command palette indexes country names and keywords in all 27 supported languages. You can type in Arabic, Japanese, Russian, or any other supported language and get accurate results.
