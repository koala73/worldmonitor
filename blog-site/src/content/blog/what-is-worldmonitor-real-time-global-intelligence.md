...
Yes. World Monitor's public interface is generated from 296 Protocol Buffer definitions into 36 REST service specifications, alongside a Model Context Protocol server with 60 live tools. Public metadata and discovery surfaces are open; data-bearing API, MCP tool, and resource calls require the appropriate Pro/API OAuth session or API key.
