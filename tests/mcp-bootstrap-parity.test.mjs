...
const EXCLUDED_FROM_MCP = new Map([
  ...
  ['bundle:heartbeat:arms-suppliers',
    'operational: seed-bundle-arms-suppliers tick-execution heartbeat — covered by /api/health, not a user-facing data slice for MCP (#6806).'],
  ['bundle:heartbeat:military-bases',
    'operational: seed-bundle-military-bases tick-execution heartbeat — covered by /api/health, not a user-facing data slice for MCP (#6806).'],
  ['digest:last-run',
