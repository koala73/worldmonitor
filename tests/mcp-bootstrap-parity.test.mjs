...
const EXCLUDED_FROM_MCP = new Map([
  ...
  ['resilience:static:index:v1',
    'deferred to a future resilience tool (paired with resilience:ranking:v21).'],
  ...
  ['resilience:intervals:v5:US',
    'deferred to a future resilience tool (formula-tagged sensitivity bands on top of resilience:ranking:v21).'],
