...
const EXCLUDED_FROM_MCP = new Map([
  ...
  ['aviation:delays:faa:v1',
    'cascade-mirror: RPC variant of aviation:delays-bootstrap:v2 (covered by get_aviation_status). Health reads the aggregate meta (seed-meta:aviation:delays-bootstrap, #6987).'],
  ['cyber:threats:v2',
