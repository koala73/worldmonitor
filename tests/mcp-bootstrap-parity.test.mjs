...
const EXCLUDED_FROM_MCP = new Map([
  ...
  ['resilience:static:index:v1',
    'deferred to a future resilience tool (paired with resilience:ranking:v20).'],
  ...
  ['resilience:intervals:v3:US',
    'deferred to a future resilience tool (formula-tagged sensitivity bands on top of resilience:ranking:v20).'],
