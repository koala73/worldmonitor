...
describe('five-factor operational wiring', () => {
  ...
  it('places the measured cheap section last with safe admission arithmetic', () => {
    ...
    assert.match(bundle, /timeoutMs:\s*35_000/);
    ...
    const scorecardReservation = 35_000 + killGraceMs;
  ...
  it('deploys when the seeder or any of its imported scorecard modules changes', () => {
    ...
    for (const file of ['_input-registry.mts', '_methodology.mts', '_score-country.mts', '_snapshot.mts', '_source-adapters.mts', '_types.mts']) {
