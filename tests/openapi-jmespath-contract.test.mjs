...
describe('OpenAPI jmespath projection parameter contract', () => {
  ...
  it('per-service JSON specs advertise jmespath on every GET (187 total)', () => {
    ...
    assert.equal(total, 187, `expected 187 GET operations, found ${total}`);
  });

  it('per-service YAML specs advertise jmespath on every GET (187 total)', () => {
  ...
  it('the unified bundle advertises jmespath on every GET (187 total)', () => {
