...
describe('OpenAPI jmespath projection parameter contract', () => {
  ...
  it('per-service JSON specs advertise jmespath on every GET (183 total)', () => {
    ...
    assert.equal(total, 183, `expected 183 GET operations, found ${total}`);
  });

  it('per-service YAML specs advertise jmespath on every GET (183 total)', () => {
  ...
  it('the unified bundle advertises jmespath on every GET (183 total)', () => {
