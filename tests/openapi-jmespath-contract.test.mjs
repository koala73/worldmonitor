...
describe('OpenAPI jmespath projection parameter contract', () => {
  ...
  it('per-service JSON specs advertise jmespath on every GET (186 total)', () => {
    ...
    assert.equal(total, 186, `expected 186 GET operations, found ${total}`);
  });

  it('per-service YAML specs advertise jmespath on every GET (186 total)', () => {
  ...
  it('the unified bundle advertises jmespath on every GET (186 total)', () => {
