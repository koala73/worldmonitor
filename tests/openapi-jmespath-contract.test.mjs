...
describe('OpenAPI jmespath projection parameter contract', () => {
  ...
  it('per-service JSON specs advertise jmespath on every GET (185 total)', () => {
    ...
    assert.equal(total, 185, `expected 185 GET operations, found ${total}`);
  });

  it('per-service YAML specs advertise jmespath on every GET (185 total)', () => {
  ...
  it('the unified bundle advertises jmespath on every GET (185 total)', () => {
