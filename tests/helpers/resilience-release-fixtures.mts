...
import { ISO2_TO_ISO3 } from '../../server/worldmonitor/conflict/v1/_shared';
...
function descriptorFor(code: string): CountryDescriptor {
  ...
  const iso3 = ISO2_TO_ISO3[upper] ?? ISO3_OVERRIDES[upper];
  if (!iso3) {
...
export function buildReleaseGateFixtures(): ReleaseGateFixtureMap {
  ...
  fixtures['displacement:summary:v1'] = { summary: { countries: displacementCountries } };
