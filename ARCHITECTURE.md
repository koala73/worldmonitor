...
| `seed-freshness-monitor.yml` | 15-minute cron, ingestion-path push to main, manual | Enforces production ingestion acceptance after a green scheduled main gate or immediately after ingestion changes; fails on every actionable compact-health problem except explicitly on-demand sources |
