...
export const SERVER_INSTRUCTIONS = [
  'Use optional `jmespath` only when a tool input schema advertises it. Server-side projection is applied AFTER per-tool filter/summary; attribution-bound tools can omit it. Typical 80-95% token reduction. Grammar: https://jmespath.org/specification.html. Guide + 12 worked examples: https://www.worldmonitor.app/docs/mcp-jmespath.',
  '',
