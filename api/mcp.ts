  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        max_stops: { type: 'string', description: 'Max stops: "0" for nonstop, "1" for one stop, or omit for any (optional)' },
        passengers: { type: 'number', description: 'Number of passengers (1-9, default 1)' },
        sort_by: { type: 'string', description: 'Sort order: "price", "duration", or "departure" (optional)' },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        is_round_trip: { type: 'boolean', description: 'Whether to search round-trip prices (default false)' },
        trip_duration: { type: 'number', description: 'Trip duration in days for round-trip calendar search (optional)' },
