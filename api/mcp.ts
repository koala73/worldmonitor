...
const TOOL_REGISTRY: ToolDef[] = [
  ...
  },
  {
    ...
    description: 'Climate anomalies, climate-relevant disaster alerts, NOAA atmospheric greenhouse gas monitoring (CO2 ppm, methane ppb, N2O ppb, Mauna Loa 12-month trend), Arctic sea ice and ocean heat indicators, weather alerts, and natural environmental events from WorldMonitor climate feeds.',
    inputSchema: { type: 'object', properties: {}, required: [] },
    _cacheKeys: ['climate:anomalies:v2', 'climate:disasters:v1', 'climate:co2-monitoring:v1', 'climate:ocean-ice:v1', 'weather:alerts:v1'],
