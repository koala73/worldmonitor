 ...
 * IntelligenceServiceHandler interface with 5 RPCs:
 ...
 *   - SearchGdeltDocuments (GDELT 2.0 Doc API news article search)
 *
...
async function handleSearchGdeltDocuments(req: SearchGdeltDocumentsRequest): Promise<SearchGdeltDocumentsResponse> {
...
export const intelligenceHandler: IntelligenceServiceHandler = {
  ...
  async searchGdeltDocuments(_ctx: ServerContext, req: SearchGdeltDocumentsRequest): Promise<SearchGdeltDocumentsResponse> {
    return handleSearchGdeltDocuments(req);
  },
};
