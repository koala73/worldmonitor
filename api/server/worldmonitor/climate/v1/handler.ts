/**
 * Climate service handler -- implements the generated ClimateServiceHandler
 * interface by fetching 15 monitored zones from the Open-Meteo Archive API.
 *
 * Fetches climate data for all zones in parallel, computes 30-day baseline
 * comparisons (last 7 days vs preceding baseline), classifies severity and
 * type, and returns proto-shaped ClimateAnomaly objects.
 *
