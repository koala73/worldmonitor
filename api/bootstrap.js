...
const BOOTSTRAP_CACHE_KEYS = {
  // Geopolitical conflict & economic impact only
...
const SLOW_KEYS = new Set([
  'bisPolicy', 'bisExchange', 'bisCredit', 'minerals',
  'sectors', 'shippingRates',
  'cyberThreats',
  'gulfQuotes', 'unrestEvents', 'ucdpEvents',
]);
const FAST_KEYS = new Set([
  'outages', 'macroSignals', 'chokepoints',
  'marketQuotes', 'commodityQuotes', 'riskScores', 'insights',
  'iranEvents', 'temporalAnomalies', 'spending', 'theaterPosture',
]);
