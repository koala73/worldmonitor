...
export const STARTUP_ECOSYSTEMS: StartupEcosystem[] = [
  ...
  },
  {
    ...
    activeStartups: 3200,
    unicorns: 8,
    topSectors: ['E-commerce', 'Fintech', 'Logistics', 'Edtech', 'Agritech', 'Healthtech'],
    majorVCs: ['East Ventures', 'Alpha JWC Ventures', 'Sequoia India/SEA', 'AC Ventures', 'MDI Ventures'],
    notableStartups: ['GoTo', 'Bukalapak', 'Traveloka', 'Xendit', 'Kopi Kenangan', 'Ajaib', 'RuangGuru', 'eFishery'],
    avgSeedRound: 700000,
    avgSeriesA: 3500000,
  },
  {
