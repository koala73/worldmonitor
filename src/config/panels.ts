...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'strategic-posture': { name: 'AI Strategic Posture', enabled: true, priority: 1, defaultRowSpan: 2 },
  ...
  cii: { name: 'Country Instability', enabled: true, priority: 1, defaultRowSpan: 2, ...(_desktop && { premium: 'enhanced' as const }) },
  'strategic-risk': { name: 'Strategic Risk Overview', enabled: true, priority: 1, ...(_desktop && { premium: 'enhanced' as const }) },
  intel: { name: 'Intel Feed', enabled: true, priority: 1 },
  'gdelt-intel': { name: 'Live Intelligence', enabled: true, priority: 1, defaultRowSpan: 2, ...(_desktop && { premium: 'enhanced' as const }) },
  ...
  'energy-complex': { name: 'Energy Complex', enabled: true, priority: 1, defaultRowSpan: 2 },
  'oil-inventories': { name: 'Oil Inventories', enabled: true, priority: 60, defaultRowSpan: 2 },
  ...
  'chat-analyst': { name: 'WM Analyst', enabled: true, priority: 1, defaultRowSpan: 2, premium: 'locked' as const },
  economic: { name: 'Macro Stress', enabled: true, priority: 1, defaultRowSpan: 2 },
  'trade-policy': { name: 'Trade Policy', enabled: true, priority: 1, defaultRowSpan: 2, premium: 'locked' as const },
  'supply-chain': { name: 'Supply Chain', enabled: true, priority: 1, defaultRowSpan: 2, ...(_desktop && { premium: 'enhanced' as const }) },
  ...
  'energy-crisis': { name: 'Energy Crisis Tracker', enabled: true, priority: 2, defaultRowSpan: 2 },
  ...
  'consumer-prices': { name: 'Consumer Prices', enabled: false, priority: 2, defaultRowSpan: 2 },
  ...
  'ucdp-events': { name: 'UCDP Conflict Events', enabled: true, priority: 2, defaultRowSpan: 2 },
  ...
  displacement: { name: 'UNHCR Displacement', enabled: true, priority: 2, defaultRowSpan: 2 },
  climate: { name: 'Climate Anomalies', enabled: true, priority: 2 },
  'climate-news': { name: 'Climate News', enabled: false, priority: 2 },
  'population-exposure': { name: 'Population Exposure', enabled: true, priority: 2 },
  'security-advisories': { name: 'Security Advisories', enabled: true, priority: 2, defaultRowSpan: 2 },
  'sanctions-pressure': { name: 'Sanctions Pressure', enabled: true, priority: 2, defaultRowSpan: 2 },
  ...
  'telegram-intel': { name: 'Telegram Intel', enabled: true, priority: 2, defaultRowSpan: 2, ...(_desktop && { premium: 'locked' as const }) },
...
const TECH_PANELS: Record<string, PanelConfig> = {
  ...
  'internet-disruptions': { name: 'Internet Disruptions', enabled: true, priority: 2, defaultRowSpan: 2 },
  'service-status': { name: 'Service Status', enabled: true, priority: 2 },
  economic: { name: 'Macro Stress', enabled: true, priority: 2, defaultRowSpan: 2 },
...
const FINANCE_PANELS: Record<string, PanelConfig> = {
  ...
  economic: { name: 'Macro Stress', enabled: true, priority: 1, defaultRowSpan: 2 },
  'trade-policy': { name: 'Trade Policy', enabled: true, priority: 1, defaultRowSpan: 2, premium: 'locked' as const },
  'sanctions-pressure': { name: 'Sanctions Pressure', enabled: true, priority: 1, defaultRowSpan: 2 },
  'supply-chain': { name: 'Supply Chain', enabled: true, priority: 1, defaultRowSpan: 2 },
  ...
  'consumer-prices': { name: 'Consumer Prices', enabled: true, priority: 1, defaultRowSpan: 2 },
...
const COMMODITY_PANELS: Record<string, PanelConfig> = {
  ...
  'supply-chain': { name: 'Supply Chain & Logistics', enabled: true, priority: 1, defaultRowSpan: 2 },
  ...
  'consumer-prices': { name: 'Consumer Prices', enabled: true, priority: 2, defaultRowSpan: 2 },
  'airline-intel': { name: 'Airline Intelligence', enabled: true, priority: 2 },
