...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'live-webcams': { name: 'ライブウェブカメラ', enabled: true, priority: 1 },
  'windy-webcams': { name: 'Windy Live Webcam', enabled: false, priority: 2 },
  insights: { name: 'AIインサイト', enabled: true, priority: 1 },
  'strategic-posture': { name: 'AI戦略態勢', enabled: true, priority: 1 },
  forecast: { name: 'AI予測', enabled: true, priority: 1, ...(_desktop && { premium: 'locked' as const }) }, // trial: unlocked on web, locked on desktop
  cii: { name: '国家不安定性', enabled: true, priority: 1, ...(_desktop && { premium: 'enhanced' as const }) },
  'strategic-risk': { name: '戦略リスク概観', enabled: true, priority: 1, ...(_desktop && { premium: 'enhanced' as const }) },
  intel: { name: 'インテルフィード', enabled: true, priority: 1 },
  'gdelt-intel': { name: 'ライブインテリジェンス', enabled: true, priority: 1, ...(_desktop && { premium: 'enhanced' as const }) },
  ...
  'disaster-correlation': { name: '災害カスケード', enabled: true, priority: 2 },
  ...
  'portfolio-impact': { name: 'Portfolio Impact', enabled: true, priority: 1 },
  'idea-radar': { name: 'Idea Radar', enabled: true, priority: 1 },
  ...
  'market-breadth': { name: 'Market Breadth', enabled: false, priority: 2 },
  ...
  'liquidity-shifts': { name: 'Liquidity Shifts', enabled: false, priority: 2 },
  'positioning-247': { name: '24/7 Positioning', enabled: false, priority: 2 },
  'gold-intelligence': { name: 'Gold Intelligence', enabled: false, priority: 60 },
  ...
  'storage-facility-map': { name: 'Strategic Storage Atlas', enabled: false, priority: 2 },
  'fuel-shortages': { name: 'Global Fuel Shortage Registry', enabled: false, priority: 2 },
  'energy-disruptions': { name: 'Energy Disruptions Log', enabled: false, priority: 2 },
  ...
  giving: { name: '世界の寄付', enabled: false, priority: 2 },
  ...
  'world-clock': { name: '世界時計', enabled: true, priority: 2 },
  'national-debt': { name: '世界債務時計', enabled: true, priority: 2 },
  'cross-source-signals': { name: '横断シグナル集約', enabled: true, priority: 2 },
  'market-implications': { name: 'AI市場への影響', enabled: true, priority: 1, premium: 'locked' as const },
  'regional-intelligence': { name: '地域インテリジェンス', enabled: false, priority: 1, premium: 'locked' as const },
...
const FINANCE_PANELS: Record<string, PanelConfig> = {
  ...
  economic: { name: 'Macro Stress', enabled: false, priority: 1 },
  'trade-policy': { name: 'Trade Policy', enabled: true, priority: 1, premium: 'locked' as const },
  ...
  'macro-tiles': { name: 'Macro Indicators', enabled: false, priority: 1 },
  ...
  'earnings-calendar': { name: 'Earnings Calendar', enabled: false, priority: 1 },
  'economic-calendar': { name: 'Economic Calendar', enabled: false, priority: 1 },
  'cot-positioning': { name: 'COT Positioning', enabled: false, priority: 2 },
  'liquidity-shifts': { name: 'Liquidity Shifts', enabled: false, priority: 1 },
  'positioning-247': { name: '24/7 Positioning', enabled: false, priority: 1 },
  'gold-intelligence': { name: 'Gold Intelligence', enabled: false, priority: 60 },
  derivatives: { name: 'Derivatives & Options', enabled: false, priority: 2 },
  fintech: { name: 'Fintech & Trading Tech', enabled: false, priority: 2 },
  'fin-regulation': { name: 'Financial Regulation', enabled: false, priority: 2 },
  ...
  'gulf-economies': { name: 'Gulf Economies', enabled: false, priority: 1 },
...
const HAPPY_PANELS: Record<string, PanelConfig> = {
  ...
  giving: { name: '世界の寄付', enabled: true, priority: 1 },
};
...
function getDefaultPanelKeys(panels: Record<string, PanelConfig>): string[] {
  return Object.entries(panels)
    .filter(([, config]) => config.premium !== 'locked')
    .map(([key]) => key);
}
...
export const VARIANT_DEFAULTS: Record<string, string[]> = {
  full:      getDefaultPanelKeys(FULL_PANELS),
  tech:      getDefaultPanelKeys(TECH_PANELS),
  finance:   getDefaultPanelKeys(FINANCE_PANELS),
  commodity: getDefaultPanelKeys(COMMODITY_PANELS),
  energy:    getDefaultPanelKeys(ENERGY_PANELS),
  happy:     getDefaultPanelKeys(HAPPY_PANELS),
};
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  finMarkets: {
    labelKey: 'header.panelCatMarkets',
    panelKeys: ['portfolio-impact', 'idea-radar', 'markets', 'markets-news', 'heatmap', 'macro-signals', 'analysis', 'polymarket'],
  },
  fixedIncomeFx: {
