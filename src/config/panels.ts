...
// ============================================
// NORDIC VARIANT (Norway + Sweden focus)
// ============================================
const NORDIC_PANELS: Record<string, PanelConfig> = {
...
const NORDIC_MAP_LAYERS: MapLayers = {
  ...
  displacement: false,
  climate: false,
  // Tech layers (disabled in nordic variant)
  startupHubs: false,
  cloudRegions: false,
  accelerators: false,
  techHQs: false,
  techEvents: false,
  // Finance layers (disabled in nordic variant)
  stockExchanges: false,
  financialCenters: false,
  centralBanks: false,
  commodityHubs: false,
...
// ============================================
export const DEFAULT_PANELS = SITE_VARIANT === 'tech' ? TECH_PANELS : SITE_VARIANT === 'finance' ? FINANCE_PANELS : SITE_VARIANT === 'nordic' ? NORDIC_PANELS : FULL_PANELS;
export const DEFAULT_MAP_LAYERS = SITE_VARIANT === 'tech' ? TECH_MAP_LAYERS : SITE_VARIANT === 'finance' ? FINANCE_MAP_LAYERS : SITE_VARIANT === 'nordic' ? NORDIC_MAP_LAYERS : FULL_MAP_LAYERS;
export const MOBILE_DEFAULT_MAP_LAYERS = SITE_VARIANT === 'tech' ? TECH_MOBILE_MAP_LAYERS : SITE_VARIANT === 'finance' ? FINANCE_MOBILE_MAP_LAYERS : SITE_VARIANT === 'nordic' ? NORDIC_MOBILE_MAP_LAYERS : FULL_MOBILE_MAP_LAYERS;
