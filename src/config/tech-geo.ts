...
export const STARTUP_HUBS: StartupHub[] = [
  ...
  { id: 'nyc', name: 'New York Tech', city: 'New York', country: 'USA', lat: 40.7128, lon: -74.006, tier: 'mega', unicorns: 100 },
  ...
  { id: 'berlin', name: 'Berlin Startup', city: 'Berlin', country: 'Germany', lat: 52.52, lon: 13.405, tier: 'major', unicorns: 15 },
  ...
  { id: 'seoul', name: 'Seoul Startup', city: 'Seoul', country: 'South Korea', lat: 37.5665, lon: 126.978, tier: 'emerging' },
...
export const ACCELERATORS: Accelerator[] = [
  ...
  { id: 'a16z-css', name: 'a16z crypto startup school', city: 'Menlo Park', country: 'USA', lat: 37.453, lon: -122.1817, type: 'accelerator' },
  ...
  { id: 'sequoia-arc', name: 'Sequoia Arc', city: 'Menlo Park', country: 'USA', lat: 37.452, lon: -122.1787, type: 'accelerator' },

  // USA - Boulder/Denver
  { id: 'techstars-boulder', name: 'Techstars Boulder', city: 'Boulder', country: 'USA', lat: 40.015, lon: -105.2705, type: 'accelerator', founded: 2006 },
  { id: 'boomtown', name: 'Boomtown', city: 'Boulder', country: 'USA', lat: 40.0193, lon: -105.2765, type: 'accelerator' },

  // USA - NYC
  { id: 'techstars-nyc', name: 'Techstars NYC', city: 'New York', country: 'USA', lat: 40.7128, lon: -74.006, type: 'accelerator' },
  ...
  { id: 'fintech-innovation', name: 'Fintech Innovation Lab', city: 'New York', country: 'USA', lat: 40.758, lon: -73.9855, type: 'accelerator' },

  // USA - Boston
  { id: 'techstars-boston', name: 'Techstars Boston', city: 'Boston', country: 'USA', lat: 42.3601, lon: -71.0589, type: 'accelerator' },
  { id: 'masschallenge', name: 'MassChallenge', city: 'Boston', country: 'USA', lat: 42.348, lon: -71.0466, type: 'accelerator', founded: 2009 },
  ...
  { id: 'google-startups', name: 'Google for Startups', city: 'Mountain View', country: 'USA', lat: 37.422, lon: -122.0841, type: 'accelerator' },
  { id: 'microsoft-accelerator', name: 'Microsoft Accelerator', city: 'Redmond', country: 'USA', lat: 47.674, lon: -122.1215, type: 'accelerator' },
  ...
  { id: 'founders-factory', name: 'Founders Factory', city: 'London', country: 'UK', lat: 51.5154, lon: -0.141, type: 'studio', founded: 2015 },
  ...
  { id: 'numa', name: 'NUMA', city: 'Paris', country: 'France', lat: 48.8651, lon: 2.349, type: 'accelerator' },

  // Europe - Germany
  { id: 'techstars-berlin', name: 'Techstars Berlin', city: 'Berlin', country: 'Germany', lat: 52.52, lon: 13.405, type: 'accelerator' },
  ...
  { id: 'startupbootcamp-berlin', name: 'Startupbootcamp Berlin', city: 'Berlin', country: 'Germany', lat: 52.52, lon: 13.405, type: 'accelerator' },
  ...
  { id: 'startup-wiseguys', name: 'Startup Wise Guys', city: 'Tallinn', country: 'Estonia', lat: 59.437, lon: 24.7536, type: 'accelerator', founded: 2012 },
  ...
  { id: 'sparklabs-sg', name: 'SparkLabs Singapore', city: 'Singapore', country: 'Singapore', lat: 1.2966, lon: 103.85, type: 'accelerator' },
  ...
  { id: 'sosv-china', name: 'SOSV Chinaccelerator', city: 'Shanghai', country: 'China', lat: 31.2243, lon: 121.469, type: 'accelerator' },
  ...
  { id: 'sparklabs-korea', name: 'SparkLabs Korea', city: 'Seoul', country: 'South Korea', lat: 37.5665, lon: 126.978, type: 'accelerator' },
  { id: 'primer', name: 'Primer', city: 'Seoul', country: 'South Korea', lat: 37.498, lon: 127.0276, type: 'accelerator' },
  ...
  { id: 'in5', name: 'in5', city: 'Dubai', country: 'UAE', lat: 25.1003, lon: 55.172, type: 'incubator' },
  { id: 'misk', name: 'Misk Accelerator', city: 'Riyadh', country: 'Saudi Arabia', lat: 24.7136, lon: 46.6753, type: 'accelerator' },
  { id: 'impact46', name: 'Impact46', city: 'Riyadh', country: 'Saudi Arabia', lat: 24.6877, lon: 46.685, type: 'accelerator' },
  ...
  { id: 'airtree', name: 'AirTree Ventures', city: 'Sydney', country: 'Australia', lat: -33.867, lon: 151.2051, type: 'accelerator' },
  ...
  { id: 'ccHub', name: 'CcHUB', city: 'Lagos', country: 'Nigeria', lat: 6.43, lon: 3.42, type: 'incubator' },
  { id: 'meltwater', name: 'Meltwater Entrepreneurial School', city: 'Accra', country: 'Ghana', lat: 5.6037, lon: -0.187, type: 'accelerator' },
];

export const TECH_HQS: TechHQ[] = [
  // ============ USA - FAANG & Big Tech ============
  { id: 'apple', company: 'Apple', city: 'Cupertino', country: 'USA', lat: 37.3349, lon: -122.009, type: 'faang', marketCap: '$3T' },
  { id: 'google', company: 'Google', city: 'Mountain View', country: 'USA', lat: 37.422, lon: -122.0841, type: 'faang', marketCap: '$2T' },
  { id: 'amazon', company: 'Amazon', city: 'Seattle', country: 'USA', lat: 47.6205, lon: -122.3493, type: 'faang', marketCap: '$1.8T' },
  { id: 'meta', company: 'Meta', city: 'Menlo Park', country: 'USA', lat: 37.453, lon: -122.1817, type: 'faang', marketCap: '$1.2T' },
  { id: 'microsoft', company: 'Microsoft', city: 'Redmond', country: 'USA', lat: 47.674, lon: -122.1215, type: 'faang', marketCap: '$3T' },
  ...
  { id: 'snowflake', company: 'Snowflake', city: 'Bozeman', country: 'USA', lat: 45.677, lon: -111.0429, type: 'public' },
  { id: 'splunk', company: 'Splunk', city: 'San Francisco', country: 'USA', lat: 37.7897, lon: -122.4, type: 'public' },
  ...
  { id: 'amd', company: 'AMD', city: 'Santa Clara', country: 'USA', lat: 37.3803, lon: -121.961, type: 'public' },
  ...
  { id: 'micron', company: 'Micron', city: 'Boise', country: 'USA', lat: 43.615, lon: -116.2023, type: 'public' },

  // USA - Software & SaaS
  { id: 'adobe', company: 'Adobe', city: 'San Jose', country: 'USA', lat: 37.3309, lon: -121.893, type: 'public' },
  ...
  { id: 'palo-alto', company: 'Palo Alto Networks', city: 'Santa Clara', country: 'USA', lat: 37.393, lon: -121.9856, type: 'public' },
  ...
  { id: 'mongodb', company: 'MongoDB', city: 'New York', country: 'USA', lat: 40.752, lon: -73.9932, type: 'public' },
  { id: 'elastic', company: 'Elastic', city: 'Mountain View', country: 'USA', lat: 37.403, lon: -122.1152, type: 'public' },
  { id: 'datadog', company: 'Datadog', city: 'New York', country: 'USA', lat: 40.7363, lon: -73.9919, type: 'public' },

  // USA - Fintech & Consumer
  { id: 'paypal', company: 'PayPal', city: 'San Jose', country: 'USA', lat: 37.376, lon: -121.9217, type: 'public' },
  ...
  { id: 'spacex', company: 'SpaceX', city: 'Hawthorne', country: 'USA', lat: 33.9207, lon: -118.328, type: 'unicorn' },
  ...
  { id: 'revolut', company: 'Revolut', city: 'London', country: 'UK', lat: 51.5154, lon: -0.141, type: 'unicorn' },
  { id: 'wise', company: 'Wise', city: 'London', country: 'UK', lat: 51.5174, lon: -0.087, type: 'public' },
  ...
  { id: 'darktrace', company: 'Darktrace', city: 'Cambridge', country: 'UK', lat: 52.2044, lon: 0.118, type: 'public' },
  ...
  { id: 'n26', company: 'N26', city: 'Berlin', country: 'Germany', lat: 52.52, lon: 13.405, type: 'unicorn' },
  ...
  { id: 'celonis', company: 'Celonis', city: 'Munich', country: 'Germany', lat: 48.1351, lon: 11.582, type: 'unicorn' },
  { id: 'personio', company: 'Personio', city: 'Munich', country: 'Germany', lat: 48.1372, lon: 11.5754, type: 'unicorn' },

  // Netherlands
  { id: 'asml', company: 'ASML', city: 'Veldhoven', country: 'Netherlands', lat: 51.42, lon: 5.4, type: 'public', marketCap: '$300B' },
  ...
  { id: 'northvolt', company: 'Northvolt', city: 'Stockholm', country: 'Sweden', lat: 59.334, lon: 18.0499, type: 'unicorn' },

  // France
  { id: 'dassault', company: 'Dassault Systèmes', city: 'Vélizy', country: 'France', lat: 48.7845, lon: 2.1896, type: 'public' },
  { id: 'criteo', company: 'Criteo', city: 'Paris', country: 'France', lat: 48.8688, lon: 2.349, type: 'public' },
  { id: 'ubisoft', company: 'Ubisoft', city: 'Montreuil', country: 'France', lat: 48.8622, lon: 2.4432, type: 'public' },
  { id: 'blablacar', company: 'BlaBlaCar', city: 'Paris', country: 'France', lat: 48.8703, lon: 2.354, type: 'unicorn' },
  ...
  { id: 'wolt', company: 'Wolt', city: 'Helsinki', country: 'Finland', lat: 60.165, lon: 24.955, type: 'unicorn' },

  // Estonia
  { id: 'bolt', company: 'Bolt', city: 'Tallinn', country: 'Estonia', lat: 59.437, lon: 24.7536, type: 'unicorn' },
  ...
  { id: 'noon', company: 'Noon', city: 'Dubai', country: 'UAE', lat: 25.112, lon: 55.138, type: 'unicorn' },
  ...
  { id: 'property-finder', company: 'Property Finder', city: 'Dubai', country: 'UAE', lat: 25.085, lon: 55.15, type: 'unicorn', marketCap: '$2B' },
  { id: 'xpanceo', company: 'XPANCEO', city: 'Dubai', country: 'UAE', lat: 25.09, lon: 55.155, type: 'unicorn', marketCap: '$1.4B' },
  { id: 'alef-edu', company: 'Alef Education', city: 'Abu Dhabi', country: 'UAE', lat: 24.47, lon: 54.36, type: 'unicorn', marketCap: '$1.9B' },
  ...
  { id: 'anghami', company: 'Anghami', city: 'Abu Dhabi', country: 'UAE', lat: 24.46, lon: 54.37, type: 'public' },
  { id: 'mashreq', company: 'Mashreq Neo', city: 'Dubai', country: 'UAE', lat: 25.2614, lon: 55.2977, type: 'public' },

  // MENA - Saudi Arabia
  { id: 'tabby', company: 'Tabby', city: 'Riyadh', country: 'Saudi Arabia', lat: 24.72, lon: 46.69, type: 'unicorn', marketCap: '$3.3B' },
  { id: 'tamara', company: 'Tamara', city: 'Riyadh', country: 'Saudi Arabia', lat: 24.7136, lon: 46.6753, type: 'unicorn', marketCap: '$1B' },
  { id: 'ninja', company: 'Ninja', city: 'Riyadh', country: 'Saudi Arabia', lat: 24.725, lon: 46.7, type: 'unicorn', marketCap: '$1.5B' },
  { id: 'stc', company: 'STC', city: 'Riyadh', country: 'Saudi Arabia', lat: 24.6877, lon: 46.685, type: 'public' },
  { id: 'stc-pay', company: 'stc pay', city: 'Riyadh', country: 'Saudi Arabia', lat: 24.7001, lon: 46.6753, type: 'unicorn', marketCap: '$1.3B' },
  { id: 'jahez', company: 'Jahez', city: 'Riyadh', country: 'Saudi Arabia', lat: 24.707, lon: 46.689, type: 'public' },
  ...
  { id: 'fawry', company: 'Fawry', city: 'Cairo', country: 'Egypt', lat: 30.05, lon: 31.2333, type: 'public' },
  ...
  { id: 'xiaomi', company: 'Xiaomi', city: 'Beijing', country: 'China', lat: 40.001, lon: 116.3062, type: 'public' },
  { id: 'huawei', company: 'Huawei', city: 'Shenzhen', country: 'China', lat: 22.724, lon: 114.1181, type: 'public' },
  ...
  { id: 'netease', company: 'NetEase', city: 'Hangzhou', country: 'China', lat: 30.29, lon: 120.1616, type: 'public' },
  { id: 'bilibili', company: 'Bilibili', city: 'Shanghai', country: 'China', lat: 31.24, lon: 121.485, type: 'public' },
  ...
  { id: 'kuaishou', company: 'Kuaishou', city: 'Beijing', country: 'China', lat: 40, lon: 116.4167, type: 'public' },
  ...
  { id: 'ather', company: 'Ather Energy', city: 'Bangalore', country: 'India', lat: 12.9352, lon: 77.61, type: 'unicorn' },
  { id: 'zerodha', company: 'Zerodha', city: 'Bangalore', country: 'India', lat: 12.9784, lon: 77.6408, type: 'unicorn', marketCap: '$2B' },
  { id: 'infosys', company: 'Infosys', city: 'Bangalore', country: 'India', lat: 12.8399, lon: 77.677, type: 'public' },
  ...
  { id: 'krutrim', company: 'Krutrim', city: 'Bangalore', country: 'India', lat: 12.9698, lon: 77.75, type: 'unicorn' },
  ...
  { id: 'paytm', company: 'Paytm', city: 'Noida', country: 'India', lat: 28.5355, lon: 77.391, type: 'public' },
  { id: 'policybazaar', company: 'PolicyBazaar', city: 'Gurgaon', country: 'India', lat: 28.4231, lon: 77.0453, type: 'public' },
  { id: 'nykaa', company: 'Nykaa', city: 'Mumbai', country: 'India', lat: 19.076, lon: 72.8777, type: 'public' },
  ...
  { id: 'dream11', company: 'Dream11', city: 'Mumbai', country: 'India', lat: 19.076, lon: 72.8777, type: 'unicorn' },
  ...
  { id: 'grab', company: 'Grab', city: 'Singapore', country: 'Singapore', lat: 1.308, lon: 103.8545, type: 'public' },
  { id: 'sea', company: 'Sea Limited', city: 'Singapore', country: 'Singapore', lat: 1.2966, lon: 103.856, type: 'public' },
  ...
  { id: 'propertyguru', company: 'PropertyGuru', city: 'Singapore', country: 'Singapore', lat: 1.2823, lon: 103.85, type: 'public' },
  { id: 'ninja-van', company: 'Ninja Van', city: 'Singapore', country: 'Singapore', lat: 1.287, lon: 103.849, type: 'unicorn', marketCap: '$2B' },
  { id: 'silicon-box', company: 'Silicon Box', city: 'Singapore', country: 'Singapore', lat: 1.2973, lon: 103.8515, type: 'unicorn' },
  { id: 'xendit', company: 'Xendit', city: 'Singapore', country: 'Singapore', lat: 1.2966, lon: 103.856, type: 'unicorn', marketCap: '$1.5B' },
  { id: 'moglix', company: 'Moglix', city: 'Singapore', country: 'Singapore', lat: 1.308, lon: 103.8545, type: 'unicorn', marketCap: '$3B' },
  ...
  { id: 'carro', company: 'Carro', city: 'Singapore', country: 'Singapore', lat: 1.2823, lon: 103.85, type: 'unicorn' },
  ...
  { id: 'traveloka', company: 'Traveloka', city: 'Jakarta', country: 'Indonesia', lat: -6.225, lon: 106.81, type: 'unicorn' },
  ...
  { id: 'blibli', company: 'Blibli', city: 'Jakarta', country: 'Indonesia', lat: -6.225, lon: 106.81, type: 'public' },
  ...
  { id: 'momo-vn', company: 'MoMo', city: 'Ho Chi Minh City', country: 'Vietnam', lat: 10.78, lon: 106.6958, type: 'unicorn' },
  { id: 'vnpay', company: 'VNPay', city: 'Hanoi', country: 'Vietnam', lat: 21.0285, lon: 105.8542, type: 'unicorn' },
  { id: 'sky-mavis', company: 'Sky Mavis', city: 'Ho Chi Minh City', country: 'Vietnam', lat: 10.762, lon: 106.6602, type: 'unicorn' },
  ...
  // ============ NORTH ASIA ============
  // Japan
  { id: 'sony', company: 'Sony', city: 'Tokyo', country: 'Japan', lat: 35.6192, lon: 139.75, type: 'public' },
  ...
  { id: 'culture-amp', company: 'Culture Amp', city: 'Melbourne', country: 'Australia', lat: -37.8166, lon: 144.964, type: 'unicorn' },
  ...
  { id: 'paystack', company: 'Paystack', city: 'Lagos', country: 'Nigeria', lat: 6.45, lon: 3.39, type: 'unicorn' },
...
export const CLOUD_REGIONS: CloudRegion[] = [
  ...
  { id: 'aws-ap-south-1', provider: 'aws', name: 'Asia Pacific (Mumbai)', city: 'Mumbai', country: 'India', lat: 19.076, lon: 72.8777, zones: 3 },
  ...
  { id: 'gcp-us-east1', provider: 'gcp', name: 'South Carolina', city: 'Moncks Corner', country: 'USA', lat: 33.196, lon: -80.0131, zones: 3 },
  ...
  // Cloudflare Edge
  { id: 'cf-sfo', provider: 'cloudflare', name: 'San Francisco', city: 'San Francisco', country: 'USA', lat: 37.6213, lon: -122.379 },
  { id: 'cf-lhr', provider: 'cloudflare', name: 'London', city: 'London', country: 'UK', lat: 51.47, lon: -0.4543 },
  { id: 'cf-nrt', provider: 'cloudflare', name: 'Tokyo', city: 'Tokyo', country: 'Japan', lat: 35.7653, lon: 140.3864 },

  // MENA Cloud Regions
  { id: 'aws-me-south-1', provider: 'aws', name: 'Middle East (Bahrain)', city: 'Manama', country: 'Bahrain', lat: 26.2285, lon: 50.586, zones: 3 },
  ...
  { id: 'gcp-me-central1', provider: 'gcp', name: 'Doha', city: 'Doha', country: 'Qatar', lat: 25.2854, lon: 51.531, zones: 3 },
