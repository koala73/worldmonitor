...
export const COMMANDS: Command[] = [
  ...
  { id: 'country:energy-profile', keywords: ['energy profile', 'country energy', 'oil imports', 'energy exposure', 'jodi', 'iea energy', 'energy shock'], label: 'Energy Profile', icon: '⚡', category: 'panels' },
