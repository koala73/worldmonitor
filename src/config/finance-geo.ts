...
export const STOCK_EXCHANGES: StockExchange[] = [
  ...
  { id: 'nyse', name: 'New York Stock Exchange', shortName: 'NYSE', city: 'New York', country: 'US', lat: 40.7069, lon: -74.0113, tier: 'mega', marketCap: 28, tradingHours: '09:30-16:00 ET', timezone: 'America/New_York', description: 'Largest stock exchange by market cap' },
  { id: 'nasdaq', name: 'NASDAQ', shortName: 'NASDAQ', city: 'New York', country: 'US', lat: 40.7568, lon: -73.986, tier: 'mega', marketCap: 24, tradingHours: '09:30-16:00 ET', timezone: 'America/New_York', description: 'Tech-heavy electronic exchange' },
  ...
  { id: 'euronext', name: 'Euronext', shortName: 'Euronext', city: 'Amsterdam', country: 'NL', lat: 52.3465, lon: 4.879, tier: 'mega', marketCap: 7.2, tradingHours: '09:00-17:30 CET', timezone: 'Europe/Amsterdam', description: 'Pan-European exchange' },
  ...
  { id: 'krx', name: 'Korea Exchange', shortName: 'KRX', city: 'Seoul', country: 'KR', lat: 37.523, lon: 126.9258, tier: 'major', marketCap: 2.2, tradingHours: '09:00-15:30 KST', timezone: 'Asia/Seoul', description: 'South Korea\'s exchange' },
  { id: 'six', name: 'SIX Swiss Exchange', shortName: 'SIX', city: 'Zurich', country: 'CH', lat: 47.3685, lon: 8.54, tier: 'major', marketCap: 2, tradingHours: '09:00-17:30 CET', timezone: 'Europe/Zurich', description: 'Switzerland\'s primary exchange' },
  ...
  { id: 'xetra', name: 'Deutsche Börse (Xetra)', shortName: 'Xetra', city: 'Frankfurt', country: 'DE', lat: 50.111, lon: 8.6804, tier: 'major', marketCap: 2.3, tradingHours: '09:00-17:30 CET', timezone: 'Europe/Berlin', description: 'Germany\'s primary exchange' },
  { id: 'twse', name: 'Taiwan Stock Exchange', shortName: 'TWSE', city: 'Taipei', country: 'TW', lat: 25.0388, lon: 121.5632, tier: 'major', marketCap: 2, tradingHours: '09:00-13:30 CST', timezone: 'Asia/Taipei', description: 'Taiwan\'s primary exchange' },
  ...
  { id: 'tadawul', name: 'Saudi Exchange (Tadawul)', shortName: 'Tadawul', city: 'Riyadh', country: 'SA', lat: 24.7103, lon: 46.677, tier: 'emerging', marketCap: 2.9, tradingHours: '10:00-15:00 AST', timezone: 'Asia/Riyadh', description: 'Saudi Arabia\'s exchange' },
  { id: 'idx', name: 'Indonesia Stock Exchange', shortName: 'IDX', city: 'Jakarta', country: 'ID', lat: -6.2293, lon: 106.813, tier: 'emerging', marketCap: 0.6, tradingHours: '09:00-15:50 WIB', timezone: 'Asia/Jakarta', description: 'Indonesia\'s primary exchange' },
  { id: 'set', name: 'Stock Exchange of Thailand', shortName: 'SET', city: 'Bangkok', country: 'TH', lat: 13.7205, lon: 100.525, tier: 'emerging', marketCap: 0.5, tradingHours: '10:00-16:30 ICT', timezone: 'Asia/Bangkok', description: 'Thailand\'s exchange' },
  ...
  { id: 'egx', name: 'Egyptian Exchange', shortName: 'EGX', city: 'Cairo', country: 'EG', lat: 30.0492, lon: 31.234, tier: 'emerging', description: 'Egypt\'s exchange' },
...
export const FINANCIAL_CENTERS: FinancialCenter[] = [
  ...
  { id: 'fc-nyc', name: 'New York', city: 'New York', country: 'US', lat: 40.758, lon: -74.0001, type: 'global', gfciRank: 1, specialties: ['Equities', 'Fixed Income', 'Derivatives', 'Banking'], description: 'World\'s largest financial center' },
  ...
  { id: 'fc-singapore', name: 'Singapore', city: 'Singapore', country: 'SG', lat: 1.2833, lon: 103.85, type: 'global', gfciRank: 3, specialties: ['Wealth Management', 'FX', 'Commodities'], description: 'Asia\'s premier financial center' },
  { id: 'fc-hongkong', name: 'Hong Kong', city: 'Hong Kong', country: 'HK', lat: 22.283, lon: 114.153, type: 'global', gfciRank: 4, specialties: ['IPOs', 'Equities', 'Wealth Management'], description: 'China gateway financial hub' },
  { id: 'fc-sanfrancisco', name: 'San Francisco', city: 'San Francisco', country: 'US', lat: 37.794, lon: -122.3999, type: 'global', gfciRank: 5, specialties: ['VC', 'Tech Finance', 'Fintech'], description: 'Tech-finance nexus' },
  ...
  { id: 'fc-seoul', name: 'Seoul', city: 'Seoul', country: 'KR', lat: 37.5665, lon: 126.978, type: 'regional', gfciRank: 6, specialties: ['Equities', 'Tech', 'Fintech'], description: 'South Korean financial hub' },
  { id: 'fc-mumbai', name: 'Mumbai', city: 'Mumbai', country: 'IN', lat: 19.076, lon: 72.8777, type: 'regional', gfciRank: 15, specialties: ['Equities', 'Derivatives', 'Fintech'], description: 'India\'s financial capital' },
  ...
  { id: 'fc-bermuda', name: 'Bermuda', city: 'Hamilton', country: 'BM', lat: 32.2949, lon: -64.782, type: 'offshore', specialties: ['Insurance', 'Reinsurance', 'ILS'], description: 'Insurance/reinsurance capital' },
...
export const CENTRAL_BANKS: CentralBank[] = [
  ...
  { id: 'boc', name: 'Bank of Canada', shortName: 'BoC', city: 'Ottawa', country: 'CA', lat: 45.423, lon: -75.701, type: 'major', currency: 'CAD', description: 'Canada\'s central bank' },
  ...
  { id: 'sama', name: 'Saudi Central Bank', shortName: 'SAMA', city: 'Riyadh', country: 'SA', lat: 24.6938, lon: 46.685, type: 'regional', currency: 'SAR', description: 'Saudi Arabia\'s central bank' },
...
export const COMMODITY_HUBS: CommodityHub[] = [
  ...
  { id: 'dce', name: 'Dalian Commodity Exchange', city: 'Dalian', country: 'CN', lat: 38.914, lon: 121.6147, type: 'exchange', commodities: ['Iron Ore', 'Soybeans', 'Palm Oil', 'Corn'], description: 'Key agricultural & metals exchange' },
  { id: 'tocom', name: 'Tokyo Commodity Exchange', city: 'Tokyo', country: 'JP', lat: 35.68, lon: 139.775, type: 'exchange', commodities: ['Rubber', 'Gold', 'Platinum', 'Crude Oil'], description: 'Japan\'s commodity derivatives market' },
