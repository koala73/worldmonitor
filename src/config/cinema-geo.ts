...
// Static, bundled data so the "Cinema Hubs" layer renders locally with no
// backend — major film festivals, studio hubs, and industry centres worldwide,
...
export const CINEMA_HUBS: CinemaHub[] = [
  // ─── India — production hubs (the "India lens") ───
  ...
  // ─── Global — production hubs & studios ───
  ...
  { id: 'cinecitta', name: 'Cinecittà Studios', lat: 41.84, lon: 12.57, kind: 'studio', city: 'Rome', country: 'Italy' },
  ...
  { id: 'tokyo-anime', name: 'Anime & film studios', lat: 35.70, lon: 139.70, kind: 'hub', city: 'Tokyo', country: 'Japan' },
];
