// Tech/AI variant - tech.intelhq.io
...
export const FEEDS: Record<string, Feed[]> = {
  ...
  security: [
    ...
    { name: 'CISA Advisories', url: 'https://rss.intelhq.io/api/rss-proxy?url=' + encodeURIComponent('https://www.cisa.gov/cybersecurity-advisories/all.xml') },
