...
export const MINING_SITES: MineSite[] = [
  ...
  {
    id: 'bangka-belitung',
    name: 'Bangka Belitung Tin Belt',
    lat: -2.75,
    lon: 106.20,
    mineral: 'Tin',
    country: 'Indonesia',
    operator: 'PT Timah (state-owned) / Various',
    status: 'producing',
    significance: 'World\'s largest tin-producing region. Accounts for ~30% of global tin supply. Alluvial and offshore dredging operations.',
    productionRank: 'World #1 tin region',
    openPitOrUnderground: 'open-pit',
  },
  {
    id: 'kundur-singkep',
    name: 'Kundur & Singkep Islands',
    lat: -0.05,
    lon: 104.60,
    mineral: 'Tin',
    country: 'Indonesia',
    operator: 'PT Timah',
    status: 'producing',
    significance: 'Historic offshore tin dredging operations in Riau Islands province.',
    openPitOrUnderground: 'open-pit',
  },
  {
    id: 'belitung-offshore',
    name: 'Belitung Offshore (Timah TIN)',
    lat: -2.95,
    lon: 107.80,
    mineral: 'Tin',
    country: 'Indonesia',
    operator: 'PT Timah',
    status: 'producing',
    significance: 'Major offshore tin dredging operation producing high-purity tin concentrate for export.',
    openPitOrUnderground: 'open-pit',
  },
];
...
export const PROCESSING_PLANTS: ProcessingPlant[] = [
  ...
  {
    id: 'morowali-smelter',
    name: 'Morowali Nickel Smelter Complex',
    lat: -2.10,
    lon: 121.90,
    type: 'smelter',
    mineral: 'Nickel',
    country: 'Indonesia',
    operator: 'Tsingshan Group (IMIP)',
    status: 'operating',
    significance: 'World\'s largest nickel processing hub. Produces nickel pig iron (NPI), ferronickel, and matte for battery supply chain.',
    outputCapacity: '~350kt Ni/yr (NPI capacity)',
  },
  {
    id: 'weda-bay-smelter',
    name: 'Weda Bay Nickel Smelter',
    lat: 0.47,
    lon: 127.94,
    type: 'smelter',
    mineral: 'Nickel',
    country: 'Indonesia',
    operator: 'Tsingshan / Eramet (IWIP)',
    status: 'operating',
    significance: 'Major NPI and ferronickel smelter complex feeding from Weda Bay laterite ore. Second-largest Indonesian nickel processing hub.',
    outputCapacity: '~150kt Ni/yr (NPI capacity)',
  },
  {
    id: 'kaimana-smelter',
    name: 'Kaimana / Pomalaa HPAL Plant',
    lat: -3.64,
    lon: 121.55,
    type: 'refinery',
    mineral: 'Nickel',
    country: 'Indonesia',
    operator: 'Vale Indonesia / Sumitomo',
    status: 'planned',
    significance: 'High-Pressure Acid Leach (HPAL) plant for battery-grade nickel and cobalt production. Part of Indonesia\'s downstream strategy for EV batteries.',
    outputCapacity: '~120kt Ni/yr (MHP capacity, planned)',
  },
  {
    id: 'bangka-tin-smelter',
    ...
    operator: 'PT Timah',
    status: 'operating',
    significance: 'World\'s largest integrated tin smelter. Refines tin concentrate from Bangka Belitung operations into high-purity (>99.9%) tin metal.',
    outputCapacity: '~70kt Sn/yr',
  },
];
