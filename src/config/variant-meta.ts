...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  reits: {
    title: 'REIT Monitor - Real Estate Investment Trust Dashboard',
    description: 'Real-time REIT monitoring dashboard with property map, macro correlation, social sentiment, and disaster exposure analysis for REIT asset managers and investors.',
    keywords: 'REIT dashboard, real estate investment trust, property market, REIT stocks, commercial real estate, REIT yield, property fund, real estate analytics, REIT social sentiment, disaster exposure',
    url: 'https://reits.worldmonitor.app/',
    siteName: 'REIT Monitor',
    shortName: 'REITMonitor',
    subject: 'Real Estate Investment Trust Monitoring',
    classification: 'REIT Dashboard, Real Estate Tracker, Property Intelligence',
    categories: ['finance', 'real-estate'],
    features: [
      'REIT stock tracking (US + China C-REITs)',
      'Macro correlation engine (FRED indicators)',
      'Social sentiment analysis (Google Places, Yelp)',
      'Property location map with disaster exposure',
      'AI morning briefing',
      'Sector rotation signals',
      'Bond yield spread indicator',
