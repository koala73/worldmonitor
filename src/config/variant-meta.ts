...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  india: {
    ...
    keywords: 'India dashboard, South Asia intelligence, India geopolitics, India markets, India defense, border monitoring, monsoon, disaster tracking, India energy, subcontinent OSINT, real-time monitoring',
    url: 'https://india.worldmonitor.app/dashboard',
    siteName: 'India Monitor',
    shortName: 'IndiaMonitor',
    subject: 'India and South Asia Geopolitical and Situation Awareness',
    classification: 'Regional Intelligence Dashboard, OSINT Tool, News Aggregator',
    categories: ['news', 'productivity'],
    features: [
      'South Asia news aggregation',
      'Regional instability scoring',
      'Border & conflict monitoring',
      'India market tracking',
  ...
  cinema: {
    ...
    description: 'Real-time cinema and entertainment dashboard — global film news, box office, OTT/streaming, festivals and awards, and studio/festival hubs, with an India lens (Bollywood + regional).',
    keywords: 'cinema dashboard, film industry, box office, Bollywood, Hollywood, OTT, streaming, film festivals, Cannes, Oscars, IFFI, entertainment news, movie releases, Tollywood, Kollywood, awards season',
    url: 'https://cinema.worldmonitor.app/dashboard',
    siteName: 'Cinema Monitor',
    shortName: 'CinemaMonitor',
    subject: 'Film, Entertainment, and Box Office Intelligence',
    classification: 'Entertainment Dashboard, Film Industry Tracker, News Aggregator',
    categories: ['entertainment', 'news'],
    features: [
      'Global entertainment news',
      'Indian cinema (Bollywood + regional)',
      'Box office tracking',
      'OTT & streaming releases',
      'Festivals & awards coverage',
      'Film festival & studio hub map',
    ],
  },
  tech: {
