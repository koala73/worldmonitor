...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  india: {
    ...
    keywords: 'India dashboard, South Asia intelligence, India geopolitics, India markets, border monitoring, monsoon, disaster tracking, India energy, subcontinent OSINT, real-time monitoring',
    url: 'https://www.worldmonitor.app/dashboard',
