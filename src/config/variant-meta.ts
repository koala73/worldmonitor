...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  universe: {
    title: 'Universe Monitor - Real-Time Global Intelligence Dashboard',
    description: 'Universe Monitor by AI Humane: a real-time global intelligence dashboard reasoning over live news, markets, military tracking, infrastructure, and geopolitical data. OSINT in one view.',
    keywords: 'global intelligence, geopolitical dashboard, world news, market data, military bases, nuclear facilities, undersea cables, conflict zones, real-time monitoring, situation awareness, OSINT, flight tracking, AIS ships, earthquake monitor, protest tracker, power outages, oil prices, government spending, polymarket predictions',
    url: 'https://app.aihumane.in/',
    siteName: 'Universe Monitor',
    shortName: 'Universe Monitor',
    subject: 'Real-Time Global Intelligence and Situation Awareness',
    classification: 'Intelligence Dashboard, OSINT Tool, News Aggregator',
    categories: ['news', 'productivity'],
    features: [
