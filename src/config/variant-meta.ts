...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  happy: {
    title: 'Happy Monitor - グッドニュースと世界の前進',
    description: '世界中の前向きなニュース、進歩データ、心が明るくなる出来事をまとめて追跡します。',
    ...
    subject: 'グッドニュース、世界の前進、人類の達成',
    classification: 'ポジティブニュースダッシュボード、進歩トラッカー',
