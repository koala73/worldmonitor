...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'The Arcane Watchtower - Arcane Worldwide Data Centre',
    description: 'The Arcane Archives worldwide data centre — real-time global intelligence: conflicts, markets, military, crypto and OSINT in one situational-awareness view.',
    keywords: 'Arcane Archives, Arcane Watchtower, global intelligence, geopolitical dashboard, world news, market data, military bases, nuclear facilities, undersea cables, conflict zones, real-time monitoring, situation awareness, OSINT, flight tracking, AIS ships, earthquake monitor, protest tracker, power outages, oil prices, crypto intel',
    url: 'https://arcane-watchtower.vercel.app/dashboard',
    siteName: 'The Arcane Watchtower',
    shortName: 'Arcane Watchtower',
    subject: 'Arcane Worldwide Data Centre — Global Intelligence and Situation Awareness',
