...
export const NUCLEAR_FACILITIES: NuclearFacility[] = [
  ...
  { id: 'palo_verde', name: 'Palo Verde', lat: 33.39, lon: -112.86, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'south_texas', name: 'South Texas', lat: 28.795, lon: -96.048, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'comanche_peak', name: 'Comanche Peak', lat: 32.30, lon: -97.79, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'vogtle', name: 'Vogtle', lat: 33.14, lon: -81.76, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'mcguire', name: 'McGuire', lat: 35.43, lon: -80.95, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'oconee', name: 'Oconee', lat: 34.79, lon: -82.90, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'catawba', name: 'Catawba', lat: 35.05, lon: -81.07, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'brunswick', name: 'Brunswick', lat: 33.96, lon: -78.01, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'calvert_cliffs', name: 'Calvert Cliffs', lat: 38.43, lon: -76.44, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'salem', name: 'Salem', lat: 39.46, lon: -75.54, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'limerick', name: 'Limerick', lat: 40.22, lon: -75.59, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'peach_bottom', name: 'Peach Bottom', lat: 39.76, lon: -76.27, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'indian_point', name: 'Indian Point', lat: 41.27, lon: -73.95, type: 'plant', status: 'inactive' , operator: 'US' },
  { id: 'millstone', name: 'Millstone', lat: 41.31, lon: -72.17, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'seabrook', name: 'Seabrook', lat: 42.90, lon: -70.85, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'byron', name: 'Byron', lat: 42.08, lon: -89.28, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'braidwood', name: 'Braidwood', lat: 41.24, lon: -88.21, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'lasalle', name: 'LaSalle', lat: 41.24, lon: -88.67, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'dresden', name: 'Dresden', lat: 41.39, lon: -88.27, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'quad_cities', name: 'Quad Cities', lat: 41.73, lon: -90.34, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'palisades', name: 'Palisades', lat: 42.32, lon: -86.32, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'dc_cook', name: 'D.C. Cook', lat: 41.98, lon: -86.56, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'davis_besse', name: 'Davis-Besse', lat: 41.60, lon: -83.09, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'beaver_valley', name: 'Beaver Valley', lat: 40.62, lon: -80.43, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'diablo_canyon', name: 'Diablo Canyon', lat: 35.21, lon: -120.85, type: 'plant', status: 'active' , operator: 'US' },
  { id: 'columbia_gen', name: 'Columbia Generating', lat: 46.47, lon: -119.33, type: 'plant', status: 'active' , operator: 'US' },
  // France (56 reactors - major sites)
  { id: 'gravelines', name: 'Gravelines', lat: 51.01, lon: 2.14, type: 'plant', status: 'active' , operator: 'FR' },
  { id: 'paluel', name: 'Paluel', lat: 49.86, lon: 0.63, type: 'plant', status: 'active' , operator: 'FR' },
  { id: 'cattenom', name: 'Cattenom', lat: 49.42, lon: 6.22, type: 'plant', status: 'active' , operator: 'FR' },
  { id: 'bugey', name: 'Bugey', lat: 45.80, lon: 5.27, type: 'plant', status: 'active' , operator: 'FR' },
  { id: 'tricastin', name: 'Tricastin', lat: 44.33, lon: 4.73, type: 'plant', status: 'active' , operator: 'FR' },
  { id: 'cruas', name: 'Cruas', lat: 44.63, lon: 4.76, type: 'plant', status: 'active' , operator: 'FR' },
  { id: 'blayais', name: 'Blayais', lat: 45.26, lon: -0.69, type: 'plant', status: 'active' , operator: 'FR' },
  { id: 'golfech', name: 'Golfech', lat: 44.11, lon: 0.85, type: 'plant', status: 'active' , operator: 'FR' },
  { id: 'flamanville', name: 'Flamanville', lat: 49.54, lon: -1.88, type: 'plant', status: 'active' , operator: 'FR' },
  { id: 'la_hague', name: 'La Hague', lat: 49.68, lon: -1.88, type: 'enrichment', status: 'active' , operator: 'FR' },
  // UK
  { id: 'hinkley_point', name: 'Hinkley Point', lat: 51.21, lon: -3.13, type: 'plant', status: 'active' , operator: 'GB' },
  { id: 'sizewell', name: 'Sizewell', lat: 52.21, lon: 1.62, type: 'plant', status: 'active' , operator: 'GB' },
  { id: 'heysham', name: 'Heysham', lat: 54.03, lon: -2.92, type: 'plant', status: 'active' , operator: 'GB' },
  { id: 'torness', name: 'Torness', lat: 55.97, lon: -2.41, type: 'plant', status: 'active' , operator: 'GB' },
  { id: 'sellafield', name: 'Sellafield', lat: 54.42, lon: -3.50, type: 'enrichment', status: 'active' , operator: 'GB' },
  // Germany (shutdown but notable)
  { id: 'neckarwestheim', name: 'Neckarwestheim', lat: 49.04, lon: 9.18, type: 'plant', status: 'inactive' , operator: 'GB' },
  { id: 'isar', name: 'Isar', lat: 48.61, lon: 12.29, type: 'plant', status: 'inactive' , operator: 'GB' },
  { id: 'emsland', name: 'Emsland', lat: 52.47, lon: 7.32, type: 'plant', status: 'inactive' , operator: 'GB' },
  // Russia
  { id: 'kursk', name: 'Kursk NPP', lat: 51.67, lon: 35.61, type: 'plant', status: 'active' , operator: 'RU' },
  { id: 'novovoronezh', name: 'Novovoronezh', lat: 51.27, lon: 39.22, type: 'plant', status: 'active' , operator: 'RU' },
  { id: 'leningrad', name: 'Leningrad NPP', lat: 59.83, lon: 29.03, type: 'plant', status: 'active' , operator: 'RU' },
  { id: 'kalinin', name: 'Kalinin NPP', lat: 57.79, lon: 35.06, type: 'plant', status: 'active' , operator: 'RU' },
  { id: 'balakovo', name: 'Balakovo', lat: 52.09, lon: 47.95, type: 'plant', status: 'active' , operator: 'RU' },
  { id: 'rostov', name: 'Rostov NPP', lat: 47.25, lon: 42.10, type: 'plant', status: 'active' , operator: 'RU' },
  { id: 'kola', name: 'Kola NPP', lat: 67.46, lon: 32.47, type: 'plant', status: 'active' , operator: 'RU' },
  { id: 'mayak', name: 'Mayak', lat: 55.71, lon: 60.80, type: 'enrichment', status: 'active' , operator: 'RU' },
  // Ukraine
  { id: 'zaporizhzhia', name: 'Zaporizhzhia NPP', lat: 47.51, lon: 34.58, type: 'plant', status: 'contested' , operator: 'UA' },
  { id: 'rivne', name: 'Rivne NPP', lat: 51.33, lon: 25.88, type: 'plant', status: 'active' , operator: 'UA' },
  { id: 'south_ukraine', name: 'South Ukraine NPP', lat: 47.81, lon: 31.22, type: 'plant', status: 'active' , operator: 'UA' },
  { id: 'khmelnytskyi', name: 'Khmelnytskyi NPP', lat: 50.30, lon: 26.65, type: 'plant', status: 'active' , operator: 'UA' },
  { id: 'chernobyl', name: 'Chernobyl', lat: 51.39, lon: 30.10, type: 'plant', status: 'inactive' , operator: 'UA' },
  // China
  { id: 'daya_bay', name: 'Daya Bay', lat: 22.60, lon: 114.54, type: 'plant', status: 'active' , operator: 'CN' },
  { id: 'taishan', name: 'Taishan', lat: 21.91, lon: 112.98, type: 'plant', status: 'active' , operator: 'CN' },
  { id: 'yangjiang', name: 'Yangjiang', lat: 21.71, lon: 112.26, type: 'plant', status: 'active' , operator: 'CN' },
  { id: 'hongyanhe', name: 'Hongyanhe', lat: 39.79, lon: 121.48, type: 'plant', status: 'active' , operator: 'CN' },
  { id: 'tianwan', name: 'Tianwan', lat: 34.69, lon: 119.46, type: 'plant', status: 'active' , operator: 'CN' },
  { id: 'fuqing', name: 'Fuqing', lat: 25.44, lon: 119.44, type: 'plant', status: 'active' , operator: 'CN' },
  { id: 'fangjiashan', name: 'Fangjiashan', lat: 30.44, lon: 120.96, type: 'plant', status: 'active' , operator: 'CN' },
  { id: 'sanmen', name: 'Sanmen', lat: 29.10, lon: 121.41, type: 'plant', status: 'active' , operator: 'CN' },
  // Japan
  { id: 'fukushima_daini', name: 'Fukushima Daini', lat: 37.32, lon: 141.03, type: 'plant', status: 'inactive' , operator: 'JP' },
  { id: 'kashiwazaki', name: 'Kashiwazaki-Kariwa', lat: 37.43, lon: 138.60, type: 'plant', status: 'inactive' , operator: 'JP' },
  { id: 'hamaoka', name: 'Hamaoka', lat: 34.62, lon: 138.14, type: 'plant', status: 'inactive' , operator: 'JP' },
  { id: 'takahama', name: 'Takahama', lat: 35.52, lon: 135.51, type: 'plant', status: 'active' , operator: 'JP' },
  { id: 'ohi', name: 'Ohi', lat: 35.54, lon: 135.66, type: 'plant', status: 'active' , operator: 'JP' },
  { id: 'sendai', name: 'Sendai', lat: 31.83, lon: 130.19, type: 'plant', status: 'active' , operator: 'JP' },
  { id: 'ikata', name: 'Ikata', lat: 33.49, lon: 132.31, type: 'plant', status: 'active' , operator: 'JP' },
  { id: 'rokkasho', name: 'Rokkasho', lat: 40.96, lon: 141.33, type: 'enrichment', status: 'active' , operator: 'JP' },
  // South Korea
  { id: 'kori', name: 'Kori', lat: 35.32, lon: 129.29, type: 'plant', status: 'active' , operator: 'KR' },
  { id: 'hanbit', name: 'Hanbit', lat: 35.41, lon: 126.42, type: 'plant', status: 'active' , operator: 'KR' },
  { id: 'hanul', name: 'Hanul', lat: 37.09, lon: 129.38, type: 'plant', status: 'active' , operator: 'KR' },
  { id: 'wolsong', name: 'Wolsong', lat: 35.71, lon: 129.47, type: 'plant', status: 'active' , operator: 'KR' },
  // India
  { id: 'tarapur', name: 'Tarapur', lat: 19.83, lon: 72.65, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'kudankulam', name: 'Kudankulam', lat: 8.17, lon: 77.71, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'kakrapar', name: 'Kakrapar', lat: 21.24, lon: 73.35, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'rawatbhata', name: 'Rawatbhata', lat: 24.88, lon: 75.59, type: 'plant', status: 'active' , operator: 'IN' },
  // Canada
  { id: 'bruce', name: 'Bruce', lat: 44.33, lon: -81.60, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'darlington', name: 'Darlington', lat: 43.87, lon: -78.72, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'pickering', name: 'Pickering', lat: 43.81, lon: -79.07, type: 'plant', status: 'active' , operator: 'IN' },
  // Others
  { id: 'paks', name: 'Paks', lat: 46.57, lon: 18.86, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'temelin', name: 'Temelín', lat: 49.18, lon: 14.38, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'dukovany', name: 'Dukovany', lat: 49.09, lon: 16.15, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'mochovce', name: 'Mochovce', lat: 48.28, lon: 18.44, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'kozloduy', name: 'Kozloduy', lat: 43.75, lon: 23.63, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'cernavoda', name: 'Cernavoda', lat: 44.32, lon: 28.05, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'ringhals', name: 'Ringhals', lat: 57.26, lon: 12.11, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'forsmark', name: 'Forsmark', lat: 60.41, lon: 18.17, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'oskarshamn', name: 'Oskarshamn', lat: 57.42, lon: 16.67, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'olkiluoto', name: 'Olkiluoto', lat: 61.24, lon: 21.44, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'loviisa', name: 'Loviisa', lat: 60.37, lon: 26.35, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'borssele', name: 'Borssele', lat: 51.43, lon: 3.72, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'doel', name: 'Doel', lat: 51.33, lon: 4.26, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'tihange', name: 'Tihange', lat: 50.53, lon: 5.27, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'almaraz', name: 'Almaraz', lat: 39.81, lon: -5.70, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'cofrentes', name: 'Cofrentes', lat: 39.21, lon: -1.05, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'asco', name: 'Ascó', lat: 41.20, lon: 0.57, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'vandellos', name: 'Vandellòs', lat: 40.95, lon: 0.87, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'trillo', name: 'Trillo', lat: 40.70, lon: -2.62, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'krsko', name: 'Krško', lat: 45.94, lon: 15.52, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'koeberg', name: 'Koeberg', lat: -33.6767, lon: 18.4347, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'atucha', name: 'Atucha', lat: -33.97, lon: -59.21, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'embalse', name: 'Embalse', lat: -32.23, lon: -64.47, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'angra', name: 'Angra', lat: -23.01, lon: -44.46, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'laguna_verde', name: 'Laguna Verde', lat: 19.719, lon: -96.406, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'barakah', name: 'Barakah', lat: 23.95, lon: 52.19, type: 'plant', status: 'active' , operator: 'IN' },
  { id: 'bushehr', name: 'Bushehr', lat: 28.83, lon: 50.89, type: 'plant', status: 'active' , operator: 'IN' },
  // Intel targets (weapons/enrichment)
  { id: 'natanz', name: 'Natanz', lat: 33.72, lon: 51.73, type: 'enrichment', status: 'active', operator: 'IR' },
  { id: 'fordow', name: 'Fordow', lat: 34.88, lon: 51.0, type: 'enrichment', status: 'active', operator: 'IR' },
  { id: 'yongbyon', name: 'Yongbyon', lat: 39.8, lon: 125.75, type: 'weapons', status: 'active', operator: 'KP' },
  { id: 'dimona', name: 'Dimona', lat: 31.0, lon: 35.15, type: 'weapons', status: 'active', operator: 'IL' },
  ...
  { id: 'punggye_ri',    name: 'Punggye-ri',     lat: 41.28, lon: 129.08,  type: 'test-site', status: 'active', operator: 'KP' },
