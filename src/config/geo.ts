...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  // Nordic hotspots
  {
    id: 'north_sea_energy',
    name: 'North Sea',
    subtext: 'Energy/Cables',
    lat: 58.5,
    lon: 3.0,
    location: 'North Sea, Norway-UK-Denmark',
    keywords: ['north sea', 'equinor', 'statnett', 'nord pool', 'offshore', 'oil platform', 'subsea cable', 'pipeline sabotage', 'johan sverdrup', 'troll field'],
    agencies: ['Equinor', 'Statnett', 'NVE'],
    description: 'Critical North Sea energy infrastructure. Equinor offshore platforms, subsea cables, interconnectors. Supply security for Northern Europe.',
    status: 'Monitoring',
    escalationScore: 2,
    escalationTrend: 'stable',
    escalationIndicators: ['Pipeline security post-Nord Stream', 'Subsea cable protection', 'Energy price volatility'],
    whyItMatters: 'Norway supplies ~25% of EU gas; North Sea infrastructure underpins European energy security',
  },
  {
    id: 'barents_arctic',
    name: 'Barents/Arctic',
    ...
    lat: 71.0,
    lon: 28.0,
    location: 'Barents Sea, Northern Norway-Russia border',
    keywords: ['barents', 'arctic', 'svalbard', 'northern fleet', 'tromsø', 'kirkenes', 'finnmark', 'arctic council', 'northern sea route', 'kola peninsula'],
    agencies: ['Norwegian Armed Forces', 'Northern Fleet (RU)', 'Arctic Council'],
    description: 'NATO northern flank. Russian Northern Fleet in Murmansk. Arctic sovereignty, resources, and shipping routes.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: ['Russian Northern Fleet activity', 'Arctic resource competition', 'Svalbard sovereignty tensions', 'GPS jamming incidents'],
    whyItMatters: 'NATO-Russia direct border; Arctic resources; Northern Sea Route geopolitics; critical for Nordic defense posture',
  },
  {
    id: 'baltic_nordic',
    name: 'Baltic Sea',
    ...
    lat: 58.0,
    lon: 19.0,
    location: 'Baltic Sea, Sweden-Finland-Baltics',
    keywords: ['baltic', 'gotland', 'nato baltic', 'baltic pipe', 'estlink', 'nordbalt', 'swedish navy', 'submarine', 'baltic states', 'kaliningrad'],
    agencies: ['Swedish Armed Forces', 'NATO MARCOM'],
    description: 'Baltic Sea security. Subsea cables and pipelines. Gotland strategic position. NATO lake post Sweden/Finland accession.',
    status: 'Monitoring',
    escalationScore: 2,
    escalationTrend: 'stable',
    escalationIndicators: ['Cable damage incidents', 'Russian Baltic Fleet movements', 'Gotland reinforcement', 'Kaliningrad tensions'],
    whyItMatters: 'Now a NATO lake; critical infrastructure crossings; Sweden/Finland NATO integration; Russian exclave pressure',
  },
  {
    id: 'stockholm_hub',
    name: 'Stockholm',
    subtext: 'Sweden/Vattenfall',
    lat: 59.3,
    lon: 18.07,
    location: 'Stockholm, Sweden',
    keywords: ['stockholm', 'sweden', 'vattenfall', 'riksbank', 'saab', 'ericsson', 'swedish defense', 'sweden nato'],
    agencies: ['Riksdag', 'Försvarsmakten', 'Vattenfall'],
    description: 'Swedish political and economic center. Vattenfall HQ. NATO newest member. Major Nordic tech hub.',
    status: 'Monitoring',
  },
  {
    id: 'oslo_hub',
    name: 'Oslo',
    subtext: 'Norway/Equinor',
    lat: 59.91,
    lon: 10.75,
    location: 'Oslo, Norway',
    keywords: ['oslo', 'norway', 'equinor', 'norges bank', 'sovereign wealth fund', 'nbim', 'norwegian defense', 'oil fund'],
    agencies: ['Storting', 'Forsvaret', 'Equinor'],
    description: 'Norwegian political center. World largest sovereign wealth fund (NBIM). Equinor HQ. NATO founding member.',
    status: 'Monitoring',
  },
];
