...
export const NUCLEAR_FACILITIES: NuclearFacility[] = [
  ...
  // Canada
  { id: 'bruce', name: 'Bruce', lat: 44.33, lon: -81.60, type: 'plant', status: 'active' , operator: 'CA' },
  { id: 'darlington', name: 'Darlington', lat: 43.87, lon: -78.72, type: 'plant', status: 'active' , operator: 'CA' },
  { id: 'pickering', name: 'Pickering', lat: 43.81, lon: -79.07, type: 'plant', status: 'active' , operator: 'CA' },
  // Others
  { id: 'paks', name: 'Paks', lat: 46.57, lon: 18.86, type: 'plant', status: 'active' , operator: 'HU' },
  { id: 'temelin', name: 'Temelín', lat: 49.18, lon: 14.38, type: 'plant', status: 'active' , operator: 'CZ' },
  { id: 'dukovany', name: 'Dukovany', lat: 49.09, lon: 16.15, type: 'plant', status: 'active' , operator: 'CZ' },
  { id: 'mochovce', name: 'Mochovce', lat: 48.28, lon: 18.44, type: 'plant', status: 'active' , operator: 'SK' },
  { id: 'kozloduy', name: 'Kozloduy', lat: 43.75, lon: 23.63, type: 'plant', status: 'active' , operator: 'BG' },
  { id: 'cernavoda', name: 'Cernavoda', lat: 44.32, lon: 28.05, type: 'plant', status: 'active' , operator: 'RO' },
  { id: 'ringhals', name: 'Ringhals', lat: 57.26, lon: 12.11, type: 'plant', status: 'active' , operator: 'SE' },
  { id: 'forsmark', name: 'Forsmark', lat: 60.41, lon: 18.17, type: 'plant', status: 'active' , operator: 'SE' },
  { id: 'oskarshamn', name: 'Oskarshamn', lat: 57.42, lon: 16.67, type: 'plant', status: 'active' , operator: 'SE' },
  { id: 'olkiluoto', name: 'Olkiluoto', lat: 61.24, lon: 21.44, type: 'plant', status: 'active' , operator: 'FI' },
  { id: 'loviisa', name: 'Loviisa', lat: 60.37, lon: 26.35, type: 'plant', status: 'active' , operator: 'FI' },
  { id: 'borssele', name: 'Borssele', lat: 51.43, lon: 3.72, type: 'plant', status: 'active' , operator: 'NL' },
  { id: 'doel', name: 'Doel', lat: 51.33, lon: 4.26, type: 'plant', status: 'active' , operator: 'BE' },
  { id: 'tihange', name: 'Tihange', lat: 50.53, lon: 5.27, type: 'plant', status: 'active' , operator: 'BE' },
  { id: 'almaraz', name: 'Almaraz', lat: 39.81, lon: -5.70, type: 'plant', status: 'active' , operator: 'ES' },
  { id: 'cofrentes', name: 'Cofrentes', lat: 39.21, lon: -1.05, type: 'plant', status: 'active' , operator: 'ES' },
  { id: 'asco', name: 'Ascó', lat: 41.20, lon: 0.57, type: 'plant', status: 'active' , operator: 'ES' },
  { id: 'vandellos', name: 'Vandellòs', lat: 40.95, lon: 0.87, type: 'plant', status: 'active' , operator: 'ES' },
  { id: 'trillo', name: 'Trillo', lat: 40.70, lon: -2.62, type: 'plant', status: 'active' , operator: 'ES' },
  { id: 'krsko', name: 'Krško', lat: 45.94, lon: 15.52, type: 'plant', status: 'active' , operator: 'SI' },
  { id: 'koeberg', name: 'Koeberg', lat: -33.6767, lon: 18.4347, type: 'plant', status: 'active' , operator: 'ZA' },
  { id: 'atucha', name: 'Atucha', lat: -33.97, lon: -59.21, type: 'plant', status: 'active' , operator: 'AR' },
  { id: 'embalse', name: 'Embalse', lat: -32.23, lon: -64.47, type: 'plant', status: 'active' , operator: 'AR' },
  { id: 'angra', name: 'Angra', lat: -23.01, lon: -44.46, type: 'plant', status: 'active' , operator: 'BR' },
  { id: 'laguna_verde', name: 'Laguna Verde', lat: 19.719, lon: -96.406, type: 'plant', status: 'active' , operator: 'MX' },
  { id: 'barakah', name: 'Barakah', lat: 23.95, lon: 52.19, type: 'plant', status: 'active' , operator: 'AE' },
  { id: 'bushehr', name: 'Bushehr', lat: 28.83, lon: 50.89, type: 'plant', status: 'active' , operator: 'IR' },
