import type { Hotspot, ConflictZone, MilitaryBase, UnderseaCable, NuclearFacility, StrategicWaterway, EconomicCenter, Spaceport, CriticalMineralProject, APTGroup } from '@/types';
...
export const STRATEGIC_WATERWAYS: StrategicWaterway[] = [
  { id: 'taiwan_strait', name: 'TAIWAN STRAIT', lat: 24, lon: 119.5, description: 'Critical shipping lane, PLA activity' },
  ...
  { id: 'bosphorus', name: 'BOSPHORUS STRAIT', lat: 41.1, lon: 29, description: 'Black Sea access, Turkey control' },
...
export const APT_GROUPS: APTGroup[] = [
  { id: 'apt28', name: 'APT28/29', aka: 'Fancy Bear/Cozy Bear', sponsor: 'Russia (GRU/FSB)', lat: 55, lon: 40 },
  { id: 'apt41', name: 'APT41', aka: 'Double Dragon', sponsor: 'China (MSS)', lat: 38, lon: 118 },
  { id: 'lazarus', name: 'Lazarus', aka: 'Hidden Cobra', sponsor: 'North Korea (RGB)', lat: 38.5, lon: 127 },
  { id: 'apt33', name: 'APT33/35', aka: 'Elfin/Charming Kitten', sponsor: 'Iran (IRGC)', lat: 34, lon: 53 },
];
...
const US_DOMESTIC_BASES: MilitaryBase[] = [
  ...
  { id: 'fort_liberty', name: 'Fort Liberty', lat: 35.14, lon: -79, type: 'us-nato', description: 'Army Special Ops. XVIII Airborne Corps.' },
  ...
  { id: 'incirlik', name: 'Incirlik AB', lat: 37, lon: 35.43, type: 'us-nato', description: 'US/Turkish base. Nuclear weapons storage site.' },
...
export const UNDERSEA_CABLES: UnderseaCable[] = [
  ...
  },
  {
    ...
    countriesServed: [
      ...
      { country: 'ES', capacityShare: 0.1, isRedundant: true },
    ],
  },
  {
    id: 'havfrue',
    name: 'Havfrue',
    points: [[-74, 40.5], [-30, 55], [5, 58], [12, 56]],
    major: true,
    capacityTbps: 108,
    rfsYear: 2020,
    ...
    countriesServed: [
      ...
      { country: 'DK', capacityShare: 0.2, isRedundant: true },
    ],
  },
  ...
  },
  {
    ...
    countriesServed: [
      ...
      { country: 'PA', capacityShare: 0.1, isRedundant: true },
    ],
  },
  ...
  // === ASIA-EUROPE (2 - SEA-ME-WE corridor + alternative) ===
  {
    id: 'seamewe6',
    name: 'SEA-ME-WE 6',
    points: [[103.8, 1.3], [80, 6], [55, 24], [43, 12], [32.5, 30], [12.5, 42], [-9, 38]],
    major: true,
    capacityTbps: 100,
    rfsYear: 2025,
    owners: ['Consortium'],
    landingPoints: [
      ...
      { country: 'FR', countryName: 'France', city: 'Marseille', lat: 43.3, lon: 5.37 },
    ],
    countriesServed: [
      { country: 'SG', capacityShare: 0.1, isRedundant: true },
      ...
      { country: 'EG', capacityShare: 0.1, isRedundant: true },
    ],
  },
  {
    id: 'flag',
    name: 'FLAG Europe-Asia',
    points: [[0, 51], [-6, 36], [32.5, 30], [55, 24], [73, 15], [103.8, 1.3], [139.7, 35.7]],
    major: true,
    capacityTbps: 10,
    rfsYear: 1997,
    ...
    landingPoints: [
      ...
      { country: 'EG', countryName: 'Egypt', city: 'Alexandria', lat: 31.2, lon: 29.92 },
      { country: 'AE', countryName: 'UAE', city: 'Dubai', lat: 25.2, lon: 55.27 },
      { country: 'IN', countryName: 'India', city: 'Mumbai', lat: 19.08, lon: 72.88 },
      { country: 'SG', countryName: 'Singapore', city: 'Singapore', lat: 1.35, lon: 103.82 },
  ...
  // === AFRICA (3 - circumnavigation + west + east backbones) ===
  {
    id: '2africa',
    name: '2Africa',
    points: [[0, 51], [-9, 38], [-17, 15], [4, 6], [18, -34], [55, -20], [55, 24], [32.5, 30]],
    major: true,
    capacityTbps: 180,
    rfsYear: 2024,
    ...
    landingPoints: [
      ...
      { country: 'SA', countryName: 'Saudi Arabia', city: 'Jeddah', lat: 21.49, lon: 39.19 },
      { country: 'EG', countryName: 'Egypt', city: 'Port Said', lat: 31.26, lon: 32.3 },
    ],
    countriesServed: [
      { country: 'NG', capacityShare: 0.3, isRedundant: true },
  ...
  },
  {
    id: 'wacs',
    name: 'WACS',
    points: [[18, -34], [12, -6], [4, 6], [-17, 15], [-6, 36], [0, 51]],
    major: true,
    capacityTbps: 14.5,
    rfsYear: 2012,
    ...
    countriesServed: [
      ...
      { country: 'GH', capacityShare: 0.3, isRedundant: false },
  ...
  },
  {
    id: 'eassy',
    name: 'EASSy',
    points: [[18, -34], [32, -26], [40, -15], [44, -12], [50, -20], [55, 24]],
    major: true,
    capacityTbps: 10,
    rfsYear: 2010,
    ...
    countriesServed: [
      { country: 'KE', capacityShare: 0.2, isRedundant: true },
      { country: 'TZ', capacityShare: 0.3, isRedundant: false },
      { country: 'MZ', capacityShare: 0.25, isRedundant: false },
      { country: 'MG', capacityShare: 0.4, isRedundant: false },
    ],
  },
  ...
  // === AMERICAS (2 - South America backbone + Europe direct) ===
  {
    id: 'sam1',
    name: 'SAm-1',
    points: [[-43, -23], [-55, -35], [-70, -33], [-77, -12]],
    major: true,
    capacityTbps: 2,
    rfsYear: 2001,
    owners: ['Telxius'],
    landingPoints: [
      ...
      { country: 'AR', countryName: 'Argentina', city: 'Buenos Aires', lat: -34.6, lon: -58.38 },
      { country: 'CL', countryName: 'Chile', city: 'Valparaiso', lat: -33.05, lon: -71.62 },
    ...
    countriesServed: [
      ...
      { country: 'CL', capacityShare: 0.1, isRedundant: true },
  ...
  // === ASIA-PACIFIC (3 - regional backbone + Australia) ===
  {
    id: 'apg',
    name: 'APG',
    points: [[139.7, 35.7], [121.5, 25], [114, 22.3], [103.8, 1.3]],
    major: true,
    capacityTbps: 54,
    rfsYear: 2016,
    ...
    countriesServed: [
      ...
      { country: 'TH', capacityShare: 0.1, isRedundant: true },
    ],
  },
  {
    id: 'indigo',
    name: 'Indigo',
    points: [[103.8, 1.3], [115, -8], [151, -34]],
    major: true,
    capacityTbps: 36,
    rfsYear: 2019,
  ...
  },
  {
    id: 'sjc',
    name: 'SJC',
    points: [[103.8, 1.3], [114, 22.3], [139.7, 35.7], [-122, 34]],
    major: true,
    capacityTbps: 28,
    rfsYear: 2013,
    ...
    countriesServed: [
      { country: 'US', capacityShare: 0.02, isRedundant: true },
      { country: 'JP', capacityShare: 0.1, isRedundant: true },
  ...
  // === ARCTIC/EUROPE (1 - Iceland connectivity) ===
  {
    id: 'farice',
    name: 'FARICE',
    points: [[-22, 64], [-7, 62], [-6, 53]],
    major: true,
    capacityTbps: 5,
    rfsYear: 2004,
    owners: ['Farice ehf'],
    landingPoints: [
      { country: 'IS', countryName: 'Iceland', city: 'Reykjavik', lat: 64.13, lon: -21.9 },
    ...
    countriesServed: [
      { country: 'IS', capacityShare: 0.6, isRedundant: false },
      { country: 'FO', capacityShare: 0.7, isRedundant: false },
    ],
  },
  ...
  // === MIDDLE EAST (1 - Gulf region) ===
  {
    id: 'falcon',
    name: 'Falcon',
    points: [[55, 24], [56, 25], [51.5, 26], [48, 29]],
    major: true,
    capacityTbps: 5,
    rfsYear: 2006,
    owners: ['GBI'],
...
export const NUCLEAR_FACILITIES: NuclearFacility[] = [
  ...
  { id: 'fordow', name: 'Fordow', lat: 34.88, lon: 51, type: 'enrichment', status: 'active' },
  { id: 'yongbyon', name: 'Yongbyon', lat: 39.8, lon: 125.75, type: 'weapons', status: 'active' },
  { id: 'dimona', name: 'Dimona', lat: 31, lon: 35.15, type: 'weapons', status: 'active' },
...
export const ECONOMIC_CENTERS: EconomicCenter[] = [
  ...
  { id: 'tsx', name: 'TSX', type: 'exchange', lat: 43.6489, lon: -79.385, country: 'Canada', marketHours: { open: '09:30', close: '16:00', timezone: 'America/Toronto' }, description: 'Toronto Stock Exchange' },
  { id: 'bovespa', name: 'B3', type: 'exchange', lat: -23.5505, lon: -46.6333, country: 'Brazil', description: 'Brazilian Stock Exchange (B3/Bovespa)' },
  // Europe
  { id: 'lse', name: 'LSE', type: 'exchange', lat: 51.5145, lon: -0.094, country: 'UK', marketHours: { open: '08:00', close: '16:30', timezone: 'Europe/London' }, description: 'London Stock Exchange' },
  { id: 'boe', name: 'Bank of England', type: 'central-bank', lat: 51.5142, lon: -0.088, country: 'UK', description: 'UK Central Bank' },
  { id: 'ecb', name: 'ECB', type: 'central-bank', lat: 50.1096, lon: 8.6732, country: 'Germany', description: 'European Central Bank - Controls EUR' },
  { id: 'euronext', name: 'Euronext', type: 'exchange', lat: 48.869, lon: 2.3364, country: 'France', marketHours: { open: '09:00', close: '17:30', timezone: 'Europe/Paris' }, description: 'Pan-European Exchange (Paris, Amsterdam, Brussels, Lisbon)' },
  ...
  { id: 'snb', name: 'SNB', type: 'central-bank', lat: 46.948, lon: 7.4474, country: 'Switzerland', description: 'Swiss National Bank' },
  // Asia-Pacific
  { id: 'tse', name: 'Tokyo SE', type: 'exchange', lat: 35.683, lon: 139.7744, country: 'Japan', marketHours: { open: '09:00', close: '15:00', timezone: 'Asia/Tokyo' }, description: 'Tokyo Stock Exchange - Nikkei' },
  ...
  { id: 'kospi', name: 'KRX', type: 'exchange', lat: 37.5665, lon: 126.978, country: 'South Korea', marketHours: { open: '09:00', close: '15:30', timezone: 'Asia/Seoul' }, description: 'Korea Exchange - KOSPI' },
  ...
  { id: 'qse', name: 'QSE', type: 'exchange', lat: 25.2854, lon: 51.531, country: 'Qatar', marketHours: { open: '09:30', close: '13:15', timezone: 'Asia/Qatar' }, description: 'Qatar Stock Exchange' },
  ...
  { id: 'bse_bahrain', name: 'Bahrain Bourse', type: 'exchange', lat: 26.2285, lon: 50.586, country: 'Bahrain', description: 'Bahrain Stock Exchange' },
...
export const SPACEPORTS: Spaceport[] = [
  ...
  { id: 'baikonur', name: 'Baikonur Cosmodrome', lat: 45.96, lon: 63.3, country: 'Kazakhstan', operator: 'Roscosmos', status: 'active', launches: 'Medium' },
  ...
  { id: 'tanegashima', name: 'Tanegashima SC', lat: 30.4, lon: 130.97, country: 'Japan', operator: 'JAXA', status: 'active', launches: 'Low' },
];
...
export const CRITICAL_MINERALS: CriticalMineralProject[] = [
  ...
  { id: 'atacama', name: 'Salar de Atacama', lat: -23.5, lon: -68.33, mineral: 'Lithium', country: 'Chile', operator: 'SQM/Albemarle', status: 'producing', significance: 'Largest brine lithium source' },
  ...
  // Cobalt
  { id: 'mutanda', name: 'Mutanda', lat: -10.78, lon: 25.8, mineral: 'Cobalt', country: 'DRC', operator: 'Glencore', status: 'producing', significance: 'World largest cobalt mine' },
