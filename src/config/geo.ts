...
export const NUCLEAR_FACILITIES: NuclearFacility[] = [
  ...
  { id: 'neckarwestheim', name: 'Neckarwestheim', lat: 49.04, lon: 9.18, type: 'plant', status: 'inactive', operator: 'DE' },
  { id: 'isar', name: 'Isar', lat: 48.61, lon: 12.29, type: 'plant', status: 'inactive', operator: 'DE' },
  { id: 'emsland', name: 'Emsland', lat: 52.47, lon: 7.32, type: 'plant', status: 'inactive', operator: 'DE' },
  // Russia
