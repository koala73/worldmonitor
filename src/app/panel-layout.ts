      ...
      <div class="header">
        ...
        return `
            ...
            <a href="${vHref('commodity', 'https://commodity.worldmonitor.app')}"
               ...
               ${vTarget('commodity')}
               title="${t('header.commod')}${SITE_VARIANT === 'commodity' ? ` ${t('common.currentVariant')}` : ''}">
              <span class="variant-icon">⛏️</span>
              <span class="variant-label">${t('header.commod')}</span>
            </a>
          ...
          <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="credit-link">
            ...
            <span class="credit-text"${SITE_VARIANT === 'commodity' ? ' style="font-size:10px"' : ''}>@eliehabib</span>
          </a>
          ${SITE_VARIANT === 'commodity' ? `<a href="https://substack.com/@chinainvesta" target="_blank" rel="noopener" class="credit-link">
            <span class="credit-text" style="font-size:10px">@JYR</span>
          </a>` : ''}
