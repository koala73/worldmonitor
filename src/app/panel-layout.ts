    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">ARCANE WATCHTOWER</span><span class="logo-mobile">The Arcane Watchtower</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://github.com/leogray15-maker/arcaneworldmonitor" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">ARCANE WATCHTOWER</span>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">THE ARCANE WATCHTOWER</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; Arcane worldwide data centre</span>
          </div>
        </div>
        <nav>
          <a href="https://arcanearchives.shop/dashboard.html" target="_blank" rel="noopener">Arcane Archives</a>
          <a href="https://github.com/leogray15-maker/arcaneworldmonitor" target="_blank" rel="noopener">Source</a>
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} The Arcane Archives &middot; Based on <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener" class="site-footer-credit">World Monitor</a> &copy; Elie Habib (AGPL-3.0)</span>
      </footer>
