/**
 * Race-safe panel call queue.
 * Buffers calls to panels before they finish initializing, then replays them.
...
// Race-safe: panels[key] is set BEFORE replay starts (panel-layout.ts),
