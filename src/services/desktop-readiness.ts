...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['api/server/worldmonitor/conflict/v1/handler.ts', 'api/server/worldmonitor/infrastructure/v1/handler.ts', 'api/server/worldmonitor/cyber/v1/handler.ts', 'api/server/worldmonitor/maritime/v1/handler.ts', 'api/server/worldmonitor/military/v1/handler.ts'],
    locality: 'api-key',
