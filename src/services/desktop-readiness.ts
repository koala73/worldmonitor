...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiRoutes: ['/api/acled-conflict', '/api/infrastructure/v1/list-internet-outages', '/api/cyber/v1/list-cyber-threats', '/api/maritime/v1/get-vessel-snapshot', '/api/opensky'],
    apiHandlers: ['api/acled-conflict.js', 'api/server/worldmonitor/infrastructure/v1/handler.ts', 'api/server/worldmonitor/cyber/v1/handler.ts', 'api/server/worldmonitor/maritime/v1/handler.ts', 'api/opensky.js'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['api/server/worldmonitor/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['api/server/worldmonitor/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['api/server/worldmonitor/military/v1/handler.ts'],
    locality: 'api-key',
