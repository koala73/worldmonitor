...
//  23. list_mission_presets()     — lists bundled mission presets for this monitor.
//  24. apply_mission_preset()     — applies a bundled preset atomically.
//  25. open_mission_picker()      — opens the mission preset picker.
//  26. get_access_context()       — reads signed-out / loading / signed-in access.
//  27. open_sign_in()             — opens the existing Clerk sign-in dialog.
//
