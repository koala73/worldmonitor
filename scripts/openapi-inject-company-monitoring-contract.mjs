...
const coverageItem = {
  ...
  description: 'Accepted values are awaiting_first_scan, identity_unresolved, adequate, partial, stale, unavailable, and needs_confirmation. identity_unresolved is not a quiet result.',
};
