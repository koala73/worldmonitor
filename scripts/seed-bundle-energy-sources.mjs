...
await runBundle('energy-sources', [
  ...
  { label: 'OWID-Energy-Mix', script: 'seed-owid-energy-mix.mjs', seedMetaKey: 'economic:owid-energy-mix', expectedSourceVersion: 'owid-energy-mix-v3', intervalMs: 35 * DAY, timeoutMs: 600_000 },
