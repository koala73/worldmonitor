...
await runBundle('derived-signals', [
  ...
  { label: 'Cross-Strait-Activity', script: 'seed-cross-strait-activity.mjs', seedMetaKey: 'military:cross-strait-activity:complete', intervalMs: 3 * HOUR, timeoutMs: 300_000, requiredEnv: ['JAPAN_MOD_PROXY_URL'] },
