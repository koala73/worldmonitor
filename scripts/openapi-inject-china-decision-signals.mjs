...
function knownValueSchema(dimension) {
  const timeRoles = {
  ...
  if (dimension === 'original_language') return nonEmptyString;
    ...
    return {
      ...objectSchema(
        ['state'],
        {
          ...
          relatedSignalId: nonEmptyString,
    ...
    return {
      ...objectSchema(
        ['state', 'assessedAt'],
        {
          ...
          assessedAt: isoInstant,
          contentAsOf: provenanceTimestamp,
        },
      ),
      oneOf: [
        {
    ...
    oneOf: [
      objectSchema(
        ['status', 'value'],
        {
          ...
          value: knownValueSchema(dimension),
        },
      ),
